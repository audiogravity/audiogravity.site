...
Generated: **2026-09-23 19:33 UTC**

## Summary

| | Tests | Passed | Failed | Skipped | Duration |
|---|---:|---:|---:|---:|---:|
| **core** PASS | 3790 | 3790 | 0 | 0 | 123.4s |
| **ui** PASS | 2317 | 2317 | 0 | 0 | 20.5s |
| **Total** PASS | **6107** | **6107** | **0** | **0** | **144.0s** |
...
**tests.test_app**
  ...
  - [+] test_tab_stats_has_no_connected_users_counter (0.64s)
...
**tests.test_audio_app_config.TestLicenceGate**
  ...
  - [+] test_guided_provisioning_stays_admin_only (0.04s)
...
**tests.test_audio_app_config.TestConfigTileInstallState**
  ...
  - [+] test_a_bare_service_name_is_still_completed (0.04s)

**tests.test_audio_app_config.TestSystemdStateStaysOffTheAudioPath**

  - [+] test_pipeline_refresh_asks_for_no_systemd_state
  - [+] test_opting_out_skips_the_lookup_entirely (0.04s)
  - [+] test_the_default_still_answers_the_config_tab (0.04s)
...
**tests.test_audio_hw.TestCacheBehaviour**
  ...
  - [+] test_read_error_does_not_poison_cache (0.12s)
...
**tests.test_auth.TestProtectedFlag**
  ...
  - [+] test_update_disable_guard_rejects_protected (0.40s)
  - [+] test_cannot_delete_self (0.02s)
  - [+] test_unprotected_account_can_be_deleted (0.40s)
  - [+] test_unprotected_account_can_be_disabled (0.47s)
...
**tests.test_auth.TestUpdateUserEmptyPassword**
  ...
  - [+] test_short_password_rejected_by_pydantic (0.49s)
...
**tests.test_auth.TestDisabledUserTimingOracle**
  ...
  - [+] test_disabled_user_returns_401 (0.84s)
...
**tests.test_broadcast.TestRefreshPublicBroadcast**
  ...
  - [+] test_missing_broadcast_keys_leave_previous_value
...
**tests.test_broadcast.TestPublicConfigProxy**
  ...
  - [+] test_serves_cache_without_ls_call
...
**tests.test_cdn_stream_endpoint.TestWhatFailureLooksLike**
  ...
  - [+] test_a_resolver_that_raises_answers_503[hra]
...
**tests.test_concurrency.TestSingleFlight**
  ...
  - [+] test_one_fill_even_when_it_declines_to_memoise (0.02s)
...
**tests.test_concurrency.TestBoundedGather**
  ...
  - [+] test_a_limit_below_one_is_refused
  - [+] test_nothing_to_do_is_not_an_error
...
**tests.test_config_validation.TestAppconfigFileIsInert**
  ...
  - [+] test_it_never_changes_which_file_the_editor_opens[/var/log/evil.conf] (0.01s)
...
**tests.test_dbus_client.TestMethodsTheServicesManagerCalls**
...
**tests.test_deb_depends.TestParseDepends**
  ...
  - [+] test_alternatives
  - [+] test_an_arch_qualifier_is_dropped
  - [+] test_a_folded_field
  - [+] test_an_unreadable_alternative_is_kept_not_dropped
  - [+] test_empty

**tests.test_deb_depends.TestParsePolicy**

  - [+] test_a_candidate_is_read
  - [+] test_none_is_none
  - [+] test_the_version_table_heading_is_not_a_package
  - [+] test_an_unknown_name_is_absent

**tests.test_deb_depends.TestParseReverseProvides**

  - [+] test_a_virtual_package_has_its_provider
  - [+] test_a_missing_package_has_none

**tests.test_deb_depends.TestSatisfies**

  - [+] test_operators[>=-2.38-True]
  - [+] test_operators[>=-2.42-False]
  - [+] test_operators[>>-2.41-True]
  - [+] test_operators[<<-2.41-False]
  - [+] test_operators[=-2.41-12+deb13u4-True]
  - [+] test_operators[<=-2.40-False]
  - [+] test_no_constraint
  - [+] test_an_unreadable_version_is_undecided
...
**tests.test_deb_depends.TestUnsatisfied**
  ...
  - [+] test_a_package_with_no_dependencies

**tests.test_deb_depends.TestBatching**

  - [+] test_several_packages_share_one_policy_call

**tests.test_deb_depends.TestWhenAptCannotBeAsked**

  - [+] test_a_failed_policy_is_no_verdict_for_anyone
  - [+] test_a_failed_showpkg_only_undecides_those_that_needed_it
  - [+] test_apt_cache_that_cannot_start_reports_none
  - [+] test_apt_cache_that_fails_reports_none

**tests.test_deb_depends.TestWhateverTheBoxLanguage**

  - [+] test_apt_cache_runs_in_the_c_locale
  ...
  - [+] test_the_real_apt_cache_names_a_candidate (3.33s)

**tests.test_deb_depends.TestWhatIsInstalledIsNotAskedOfApt**

  - [+] test_dependencies_all_installed_need_no_apt_call
  - [+] test_only_what_is_not_installed_is_asked
  - [+] test_an_installed_version_too_old_is_asked_of_apt
  - [+] test_a_virtual_package_is_met_by_what_provides_it
  - [+] test_a_versioned_need_on_a_provided_name_is_left_to_apt
  - [+] test_when_dpkg_cannot_be_read_apt_is_asked_everything
  - [+] test_the_real_database_is_read (0.02s)

**tests.test_deb_file.TestReadControl**

  - [+] test_it_reads_the_fields (0.01s)
  - [+] test_field_names_are_lowercased
  - [+] test_a_folded_field_keeps_its_continuation_lines
  - [+] test_it_reads_a_gzip_control_member
  - [+] test_it_reads_an_uncompressed_control_member
  - [+] test_it_says_nothing_rather_than_guess_on_a_non_package
  - [+] test_it_says_nothing_when_the_control_member_is_truncated
  - [+] test_it_says_nothing_when_there_is_no_control_member

**tests.test_deb_file.TestInstalledSize**

  - [+] test_it_converts_kibibytes_to_bytes
  - [+] test_a_package_that_declares_nothing_gives_none
  - [+] test_an_unreadable_size_gives_none_rather_than_zero
  - [+] test_it_tolerates_surrounding_space

**tests.test_deb_file.TestDebconfNotes**

  - [+] test_it_returns_the_notes_in_order
  - [+] test_it_leaves_out_anything_that_asks_a_question
  - [+] test_a_lone_dot_becomes_a_blank_line
  - [+] test_a_package_without_templates_has_no_notes
  - [+] test_it_says_nothing_on_a_non_package

**tests.test_deb_file.TestReadLocal**

  - [+] test_it_reads_a_small_package_whole
  - [+] test_it_reads_only_the_window_of_a_large_one (0.58s)
  - [+] test_the_window_is_enough_for_a_real_control_member (1.51s)
  - [+] test_a_missing_file_raises

**tests.test_deb_file.TestHostileHeaders**

  - [+] test_a_negative_member_size_ends_the_walk[-60]
  - [+] test_a_negative_member_size_ends_the_walk[-61]
  - [+] test_a_negative_member_size_ends_the_walk[-1]
  - [+] test_a_negative_installed_size_is_not_a_size
  - [+] test_zero_is_a_legitimate_size

**tests.test_deb_file.TestDamagedControlMembers**

  - [+] test_truncated_gzip
  - [+] test_corrupt_deflate
  - [+] test_tar_body_cut_short
  - [+] test_garbage_xz
...
**tests.test_file_cache.TestBounds**

  - [+] test_refuses_to_exist_without_a_bound
  ...
  - [+] test_both_bounds_apply (0.03s)

**tests.test_file_cache.TestKeys**

  - [+] test_refuses_an_unusable_key_on_promote[../escape]
  - [+] test_refuses_an_unusable_key_on_promote[a/b]
  - [+] test_refuses_an_unusable_key_on_promote[]
  - [+] test_refuses_an_unusable_key_on_promote[a b]
  - [+] test_refuses_an_unusable_key_on_promote[a.flac]
  - [+] test_refuses_an_unusable_key_on_promote[a;b]
  - [+] test_refuses_an_unusable_key_on_promote[abc\n]
...
**tests.test_file_cache.TestLifecycle**

  - [+] test_wipes_the_directory_on_construction (0.01s)
  - [+] test_new_temp_is_unique_and_inside_the_cache
...
**tests.test_highresaudio.TestConnectionState**
  ...
  - [+] test_a_purchases_only_account_says_so (0.02s)
  - [+] test_disconnected_has_no_opinion (0.02s)
...
**tests.test_highresaudio.TestHighresaudioWrites**

  - [+] test_a_write_is_a_post_carrying_the_session_in_the_query
  - [+] test_a_read_still_goes_out_as_a_get
  - [+] test_a_write_refused_for_a_dead_session_is_sent_again_once (0.01s)
  - [+] test_a_write_that_timed_out_is_not_sent_again
  - [+] test_a_write_without_any_session_logs_in_first

**tests.test_highresaudio.TestHighresaudioSubscriptionRidesOnTraffic**

  - [+] test_a_content_answer_records_the_plan
  - [+] test_a_content_answer_records_a_plan_that_ended
  - [+] test_any_other_status_is_left_alone
  - [+] test_the_config_is_written_only_when_the_state_moves
  - [+] test_reading_the_state_never_calls_hra
  - [+] test_a_stored_plan_is_seeded_at_startup

**tests.test_highresaudio.TestHighresaudioStateIsNotCarriedAcross**

  - [+] test_an_unrecognised_login_shape_forgets_the_previous_state
  - [+] test_a_browse_answer_after_disconnect_does_not_recreate_the_config
...
**tests.test_highresaudio_library.TestHraPlaylistGroups**
  ...
  - [+] test_a_group_whose_id_is_zero_is_listed_AND_can_be_opened
  - [+] test_two_groupings_of_the_same_title_are_said_out_loud
  - [+] test_a_group_with_an_unusable_id_is_dropped
...
**tests.test_highresaudio_library.TestOneRequestPerMemo**
...
**tests.test_highresaudio_library.TestHraPlaylistCreate**
  ...
  - [+] test_a_playlist_is_created_and_named_by_its_family
  - [+] test_a_description_is_sent_only_when_given
  - [+] test_the_session_hra_echoes_back_never_leaves
  - [+] test_a_nameless_playlist_is_refused_before_asking
  - [+] test_a_refusal_from_hra_is_not_reported_as_a_creation

**tests.test_highresaudio_library.TestHraPlaylistAdd**

  - [+] test_a_track_is_added
  - [+] test_a_track_already_there_is_not_added_twice
  - [+] test_an_album_brings_only_what_the_playlist_lacks_in_album_order
  - [+] test_an_album_never_goes_through_the_route_that_doubles_its_last_track
  - [+] test_an_album_already_complete_sends_nothing
  - [+] test_an_album_lacking_one_track_sends_that_one
  - [+] test_a_double_tap_writes_the_track_once
  - [+] test_a_refused_write_is_not_reported_as_added
  - [+] test_only_the_accounts_own_playlists_take_additions[5549]
  - [+] test_only_the_accounts_own_playlists_take_additions[editorial:63]
  - [+] test_only_the_accounts_own_playlists_take_additions[mine:]
  - [+] test_only_the_accounts_own_playlists_take_additions[]
  - [+] test_items_that_cannot_go_in_are_refused_before_asking[vault:t1_a_tx-track]
  - [+] test_items_that_cannot_go_in_are_refused_before_asking[vault:a_tx-album]
  - [+] test_items_that_cannot_go_in_are_refused_before_asking[t1_a,t2_a-track]
  - [+] test_items_that_cannot_go_in_are_refused_before_asking[notatrack-track]
  - [+] test_items_that_cannot_go_in_are_refused_before_asking[-album]
  - [+] test_items_that_cannot_go_in_are_refused_before_asking[t1_a-artist]

**tests.test_highresaudio_library.TestPlaylistDispatch**

  - [+] test_the_account_playlists_are_the_mine_family
  - [+] test_a_source_not_written_yet_is_refused_by_name[src_qobuz]
  - [+] test_a_source_not_written_yet_is_refused_by_name[src_tidal]
  - [+] test_a_source_not_written_yet_is_refused_by_name[src_mpd]
  - [+] test_a_source_not_written_yet_is_refused_by_name[upnp:uuid:x]
  - [+] test_a_write_without_an_account_says_so

**tests.test_highresaudio_library.TestHraPlaylistAddReadsStrictly**

  - [+] test_a_failed_read_stops_the_add_before_any_write
  - [+] test_an_unknown_playlist_is_refused
  - [+] test_a_deleted_playlist_is_refused_though_hra_still_reads_it
  - [+] test_an_empty_playlist_is_read_as_empty
  - [+] test_an_album_hra_did_not_return_is_its_failure_not_a_refusal
  - [+] test_an_album_whose_tracks_carry_no_playlist_id_is_refused

**tests.test_highresaudio_library.TestHraCreatedPlaylistsStayListed**

  - [+] test_a_new_playlist_is_listed_before_hra_lists_it_then_once
  - [+] test_the_browse_grid_sees_it_too
  - [+] test_a_playlist_hra_never_lists_is_forgotten_after_its_bound (0.03s)

**tests.test_highresaudio_library.TestHraReadersSurviveAStringData**

  - [+] test_the_playlist_list
  - [+] test_a_playlist_s_tracks

**tests.test_highresaudio_library**

  - [+] test_each_service_has_its_own_write_lock

**tests.test_highresaudio_library.TestHraPlayFromATrack**
  ...
  - [+] test_a_negative_start_never_reaches_the_service
  - [+] test_mpd_plays_the_track_asked_for_first

**tests.test_highresaudio_library.TestQueueStartIsRefusedWhereItWouldBeDropped**

  - [+] test_refused[src_qobuz-playlist]
  - [+] test_refused[src_tidal-album]
  - [+] test_refused[src_mpd-album]
  - [+] test_refused[src_highresaudio-track]
  - [+] test_refused[upnp:uuid:x-track]
  - [+] test_taken_where_it_is_honoured[album]
  - [+] test_taken_where_it_is_honoured[playlist]
  - [+] test_no_start_is_never_refused

**tests.test_highresaudio_library.TestHraAccountPlaylistIsReadStrictly**

  - [+] test_a_deleted_playlist_is_refused_not_shown
  - [+] test_an_unknown_playlist_is_refused
  - [+] test_a_failed_read_is_an_error_not_an_empty_playlist
  - [+] test_an_empty_playlist_is_still_empty
  - [+] test_tracks_are_numbered_as_listed

**tests.test_highresaudio_library.TestHraPlaylistRemove**

  - [+] test_a_track_is_taken_out
  - [+] test_a_track_the_playlist_does_not_hold_sends_nothing
  - [+] test_what_cannot_be_removed_is_refused_before_asking[editorial:63-t1_a]
  - [+] test_what_cannot_be_removed_is_refused_before_asking[5549-t1_a]
  - [+] test_what_cannot_be_removed_is_refused_before_asking[mine:5549-t1_a,t2_a]
  - [+] test_what_cannot_be_removed_is_refused_before_asking[mine:5549-vault:t1_a_tx]
  - [+] test_a_failed_read_writes_nothing

**tests.test_highresaudio_library.TestHraPlaylistRename**

  - [+] test_the_name_and_the_description_go_together
  - [+] test_an_empty_description_is_sent_to_clear_it
  - [+] test_the_session_hra_echoes_back_never_leaves
  - [+] test_the_new_name_is_listed_before_hra_catches_up
  - [+] test_a_rename_just_after_the_creation_beats_hra_s_first_name
  - [+] test_a_rename_that_names_no_description_keeps_the_current_one
  - [+] test_renaming_a_playlist_just_created_keeps_it_listed
  - [+] test_what_cannot_be_renamed_is_refused_before_writing[editorial:63-A]
  - [+] test_what_cannot_be_renamed_is_refused_before_writing[mine:5549-   ]
  - [+] test_a_playlist_that_no_longer_exists_is_refused

**tests.test_highresaudio_library.TestHraPlaylistDelete**

  - [+] test_a_playlist_is_deleted_and_leaves_the_list_at_once
  - [+] test_a_deletion_is_kept_until_it_expires_not_until_hra_agrees
  - [+] test_a_playlist_just_created_then_deleted_is_not_listed
  - [+] test_an_id_that_is_not_a_number_never_reaches_hra[mine:5549,5550]
  - [+] test_an_id_that_is_not_a_number_never_reaches_hra[mine:5549abc]
...
**tests.test_highresaudio_library.TestPlaylistStep2Dispatch**

  - [+] test_the_tracks_of_a_playlist
  - [+] test_other_sources_are_refused_by_name[src_qobuz]
  - [+] test_other_sources_are_refused_by_name[src_tidal]
  - [+] test_other_sources_are_refused_by_name[src_mpd]
...
**tests.test_hqplayer.TestAnswerReader**

  - [+] test_parses_one_answer
  - [+] test_a_closed_connection_is_no_answer
  - [+] test_silence_past_the_read_window_is_no_answer (0.05s)
  - [+] test_two_answers_in_one_read_are_two_answers
  - [+] test_the_newline_left_by_a_read_boundary_is_skipped
  - [+] test_a_declaration_cut_by_a_read_is_joined
  - [+] test_a_malformed_answer_fails_and_the_next_one_still_reads
...
**tests.test_hqplayer.TestPlaybackWatch**
  ...
  - [+] test_the_shared_status_cache_is_never_evicted (0.02s)
...
**tests.test_hqplayer.TestCodecFromUri**
  ...
  - [+] test_query_and_fragment_are_stripped[http://box:8000/library/stream/a/b.m4a?sig=0123abcd-M4A]
...
**tests.test_hqplayer.TestAssertDecodable**
  ...
  - [+] test_the_box_s_own_is_left_by_a_profile_not_by_a_switch
  - [+] test_the_push_names_the_box_s_own_when_it_plays
  - [+] test_a_push_to_the_box_s_own_is_refused_with_the_profile_advice
...
**tests.test_hqplayer.TestRememberedLengthDiesWithItsTrack**
  ...
  - [+] test_the_record_itself_is_never_read_for_a_length

**tests.test_hqplayer.TestTheDeclaredLengthFillsIn**

  - [+] test_it_gives_the_scale_when_hqplayer_measures_none
  - [+] test_hqplayer_measurement_wins (0.01s)
  - [+] test_a_measurement_is_not_replaced_mid_track
  - [+] test_a_transient_stop_keeps_the_declared_scale (0.01s)
  - [+] test_the_next_track_gets_its_own_length
  - [+] test_a_live_stream_next_does_not_inherit_it (0.01s)
...
**tests.test_hqplayer.TestPublicCallersKeepTheirMetadata**
  ...
  - [+] test_play_uri_now_records_the_album

**tests.test_hqplayer.TestFollowsThePushedPlaylist**

  - [+] test_the_screen_moves_with_the_track
  - [+] test_the_cover_moves_with_it
  - [+] test_the_declared_length_moves_with_it
  - [+] test_no_declared_length_without_a_followed_list
  - [+] test_a_pushed_duration_reaches_the_status
  - [+] test_a_read_in_flight_while_a_push_lands_declares_no_length
  - [+] test_a_track_index_of_zero_leaves_the_record_alone
  - [+] test_a_playlist_changed_outside_ag_is_disowned
  - [+] test_an_index_past_the_list_shows_nothing_rather_than_the_wrong_track
  - [+] test_an_append_keeps_the_album_named_while_hqplayer_catches_up
  - [+] test_and_follows_the_track_once_it_has
  - [+] test_only_the_previous_count_is_excused_not_any_other
  - [+] test_the_excuse_lapses_rather_than_standing_for_ever
  - [+] test_a_stopped_hqplayer_does_not_hold_the_excuse_open
  - [+] test_two_appends_in_a_row_wait_on_the_oldest_count
  - [+] test_a_play_is_never_excused
  - [+] test_letting_a_list_go_lets_go_of_its_count_too
  - [+] test_a_push_past_the_cap_lets_the_count_go_with_the_list
...
**tests.test_hqplayer.TestAnswersGoToTheirCommand**
  ...
  - [+] test_a_command_waits_longer_than_a_status_poll (0.21s)
  - [+] test_the_status_poll_keeps_the_short_one (0.06s)
...
**tests.test_hqplayer.TestAPushIsReadBack**

  - [+] test_everything_kept
  - [+] test_a_dropped_track_is_named_and_the_rest_stays_labelled
  - [+] test_nothing_kept_fails_at_once_and_names_the_tracks
  - [+] test_unmatchable_addresses_label_nothing_rather_than_wrong
  - [+] test_answers_that_do_not_line_up_are_not_trusted
  - [+] test_an_append_that_loses_a_track_says_so_and_spares_the_album_playing
  - [+] test_an_append_kept_whole_reports_the_count
  - [+] test_an_append_nothing_kept_is_an_error

**tests.test_hqplayer.TestTheCountNeverGoesWrong**
...
**tests.test_hqplayer.TestKeptIndexes**
  ...
  - [+] test_same_count_means_everything_was_kept
  - [+] test_matched_in_order_ignoring_the_query_hqplayer_strips
  - [+] test_addresses_that_do_not_line_up_give_no_answer
  - [+] test_an_address_spelled_with_or_without_escapes_is_one_address
  - [+] test_an_untitled_refusal_is_named_after_its_file

**tests.test_hqplayer.TestRefusalMessage**

  - [+] test_a_long_refusal_names_five_tracks_then_stops
...
**tests.test_hqplayer.TestAnAnswerWithAnEmbeddedCover**
  ...
  - [+] test_the_end_of_the_root_is_seen

**tests.test_hqplayer.TestDiscoveryScansWhereTheBoxIsNow**

  - [+] test_the_address_is_probed_afresh (0.01s)
  - [+] test_the_box_itself_is_not_offered (0.18s)

**tests.test_hqplayer.TestTheCardChoosesAnotherMachine**

  - [+] test_this_box_is_refused_and_nothing_changes[127.0.0.1]
  - [+] test_this_box_is_refused_and_nothing_changes[127.0.0.2]
...
**tests.test_hqplayer.TestStreamBaseUrl**
  ...
  - [+] test_the_address_on_the_route_toward_hqplayer
  - [+] test_the_override_wins
  - [+] test_a_host_named_rather_than_numbered_uses_the_connection_s_route
  - [+] test_an_ipv6_route_falls_back_to_the_box_s_own_v4_address
  - [+] test_an_address_seen_for_another_instance_is_not_served
  - [+] test_the_override_must_be_an_http_base_url[http://203.0.113.5:18000/-http://203.0.113.5:18000]
  - [+] test_the_override_must_be_an_http_base_url[  https://proxy.lan/ag/ -https://proxy.lan/ag]
  - [+] test_the_override_must_be_an_http_base_url[10.0.4.202:8000-]
  - [+] test_the_override_must_be_an_http_base_url[ftp://10.0.4.202-]
...
**tests.test_hqplayer.TestPairingWithTheLocalNaa**
  ...
  - [+] test_the_epoch_does_not_hide_the_line
...
**tests.test_hqplayer.TestNaaPackageNameMatchesTheRegistry**
  ...
  - [+] test_the_two_agree
  - [+] test_the_registry_no_longer_calls_the_adaptor_hqplayer

**tests.test_hqplayer.TestReadingWhoHqplayerIs**

  - [+] test_reads_product_engine_and_major
  - [+] test_falls_back_to_the_engine_when_version_is_absent
  - [+] test_a_major_of_zero_is_not_mistaken_for_absent
  - [+] test_asks_once_and_keeps_the_answer
  - [+] test_a_refusal_is_not_kept_as_an_identity
  - [+] test_a_silent_instance_is_not_asked_again_and_again
  - [+] test_an_answer_that_lands_after_the_target_moved_is_dropped

**tests.test_hqplayer.TestForgettingWhoHqplayerWas**

  - [+] test_the_status_poll_drops_it
  - [+] test_changing_address_drops_it

**tests.test_hqplayer.TestPairingComparison**

  - [+] test_both_directions_and_the_unknowns[5-5.1.8-68-True]
  - [+] test_both_directions_and_the_unknowns[6-6.1.4-71-True]
  - [+] test_both_directions_and_the_unknowns[5-6.1.4-71-False]
  - [+] test_both_directions_and_the_unknowns[6-5.1.8-68-False]
  - [+] test_both_directions_and_the_unknowns[5-1:5.1.8-68-True]
  - [+] test_both_directions_and_the_unknowns[5-5.1.8-68+deb13u1-True]
  - [+] test_both_directions_and_the_unknowns[None-5.1.8-68-None]
  - [+] test_both_directions_and_the_unknowns[5-None-None]
  - [+] test_both_directions_and_the_unknowns[5-nightly-None]

**tests.test_hqplayer.TestNaaVersionIsReadOnce**

  - [+] test_read_once_then_remembered
  - [+] test_not_installed_is_an_answer_and_is_remembered
  - [+] test_installing_one_makes_the_cache_wrong_so_it_is_dropped

**tests.test_hqplayer.TestProbeSpeaksToARealSocket**

  - [+] test_both_answers_arrive_on_one_connection (0.20s)
  - [+] test_two_answers_glued_into_one_read_are_still_separated (0.20s)
  - [+] test_an_instance_that_ignores_the_second_question_still_identifies (0.20s)

**tests.test_hqplayer_embedded_output.TestTheFileEdit**

  - [+] test_the_output_is_set_and_the_commented_card_left_alone
  - [+] test_a_naa_output_becomes_the_sound_card
  - [+] test_its_rates_are_left_as_the_user_set_them
  - [+] test_a_file_without_rates_takes_its_output_all_the_same
  - [+] test_a_file_without_its_output_is_left_untouched
  - [+] test_it_is_a_player_whose_output_can_be_switched

**tests.test_hqplayer_embedded_output.TestTheConfigurationService**

  - [+] test_hqplayer_s_file_is_known_as_hqplayer_s
  - [+] test_it_is_written_as_hqplayer
  - [+] test_any_other_file_is_still_written_as_root
  - [+] test_a_running_hqplayer_is_restarted_only_if_it_still_runs
  - [+] test_a_save_never_starts_a_stopped_hqplayer_nor_says_it_restarted
  - [+] test_an_output_set_while_it_is_stopped_is_applied
  - [+] test_the_state_is_read_by_the_core_s_services_manager
  - [+] test_other_services_restart_as_before
  - [+] test_its_tile_shows_the_card_it_plays_to[<?xml version="1.0" encoding="utf-8"?>\n<hqplayerd>\n\t<output type="alsa"/>\n\t<sdm modulator="33" oversampling="43" oversampling1x="40" bitrate="0"/>\n\t<engine>\n\t\t<defaults bitrate="11289600" samplerate="384000" volume="-3"/>\n\t\t<alsa channel_offset="0" dac_bits="24" device="hw:0,0" dualwire="0"/>\n\t\t<!-- RME ADI-2 Pro\n\t\t<alsa channel_offset="0" dac_bits="0" device="hw:Pro,DEV=0" dualwire="0"/>-->\n\t</engine>\n</hqplayerd>\n-hw:0,0]
  - [+] test_its_tile_shows_the_card_it_plays_to[<?xml version="1.0" encoding="utf-8"?>\n<hqplayerd>\n\t<output type="alsa"/>\n\t<sdm modulator="33" oversampling="43" oversampling1x="40" bitrate="0"/>\n\t<engine>\n\t\t<defaults bitrate="11289600" samplerate="384000" volume="-3"/>\n\t\t<alsa channel_offset="0" dac_bits="24" device="null" dualwire="0"/>\n\t\t<!-- RME ADI-2 Pro\n\t\t<alsa channel_offset="0" dac_bits="0" device="hw:Pro,DEV=0" dualwire="0"/>-->\n\t</engine>\n</hqplayerd>\n-None]
  - [+] test_its_tile_shows_the_card_it_plays_to[<?xml version="1.0" encoding="utf-8"?>\n<hqplayerd>\n\t<output type="network"/>\n\t<sdm modulator="33" oversampling="43" oversampling1x="40" bitrate="0"/>\n\t<engine>\n\t\t<defaults bitrate="11289600" samplerate="384000" volume="-3"/>\n\t\t<alsa channel_offset="0" dac_bits="24" device="hw:0,0" dualwire="0"/>\n\t\t<!-- RME ADI-2 Pro\n\t\t<alsa channel_offset="0" dac_bits="0" device="hw:Pro,DEV=0" dualwire="0"/>-->\n\t</engine>\n</hqplayerd>\n-None]
  - [+] test_its_tile_shows_the_card_it_plays_to[<not xml-None]
  - [+] test_it_has_a_file_the_editor_knows
  - [+] test_it_is_read_but_never_rewritten_whole

**tests.test_hqplayer_embedded_output.TestTheTwoDeclarationsAgree**

  - [+] test_same_file_same_owner

**tests.test_hqplayer_embedded_output.TestTheSelector**

  - [+] test_hqplayer_as_the_output_is_moved_where_it_renders[True-hqplayerd]
  - [+] test_hqplayer_as_the_output_is_moved_where_it_renders[False-naa]
  - [+] test_any_other_service_is_its_own
  - [+] test_switching_hqplayer_embedded_sets_its_output

**tests.test_hqplayer_embedded_output.TestTheNowPlayingGate**

  - [+] test_through_the_naa_or_on_the_box[False-True-True]
  - [+] test_through_the_naa_or_on_the_box[True-False-True]
  - [+] test_through_the_naa_or_on_the_box[False-False-False]
  - [+] test_no_hqplayer_module_shows_nothing

**tests.test_hqplayer_embedded_output.TestTheSignalPath**
...
**tests.test_hqplayer_local_instance.TestTheRegistryDeclaresIt**
  ...
  - [+] test_one_package_declares_an_hqplayer_instance
  - [+] test_its_unit_is_the_one_it_restarts
  - [+] test_its_port_is_a_port
  - [+] test_its_service_is_managed
  - [+] test_it_declares_what_the_vendor_limits_without_a_licence
  - [+] test_the_notice_reaches_the_package_view
...
**tests.test_hqplayer_local_instance.TestFindingTheDeclaration**
  ...
  - [+] test_found_with_its_label
  - [+] test_the_web_port_comes_from_the_credentials_it_already_declares
  - [+] test_no_web_port_when_the_package_declares_no_interface
  - [+] test_none_without_a_declaration
  - [+] test_none_without_the_packages_module
  - [+] test_a_malformed_block_declares_nothing[spec0]
  - [+] test_a_malformed_block_declares_nothing[spec1]
  - [+] test_a_malformed_block_declares_nothing[spec2]
  - [+] test_a_malformed_block_declares_nothing[spec3]
  - [+] test_the_packages_module_puts_its_manager_where_it_is_read

**tests.test_hqplayer_local_instance.TestTheTarget**

  - [+] test_the_box_own_while_it_runs
  - [+] test_the_card_s_when_it_does_not
  - [+] test_nothing_declared_means_never_local
  - [+] test_the_box_own_is_the_output_whatever_the_card_says
...
**tests.test_hqplayer_local_instance.TestFollowingTheUnit**
  ...
  - [+] test_a_job_of_the_box_own_unit_refreshes
  - [+] test_other_jobs_are_ignored
  - [+] test_a_start_during_the_first_read_is_not_lost
  - [+] test_a_start_moves_the_target_and_forgets_the_other
  - [+] test_the_first_seed_moves_nothing
  - [+] test_the_seed_reads_the_box_own_unit

**tests.test_hqplayer_local_instance.TestTheCardSInstanceIsLeftAlone**

  - [+] test_its_output_setting_cannot_be_turned_off_meanwhile
  - [+] test_re_asserting_what_the_api_answers_changes_nothing
  - [+] test_a_dsp_choice_on_the_box_own_is_not_saved_for_it
  - [+] test_its_saved_dsp_is_not_applied_to_the_box_own
  - [+] test_the_box_own_dsp_is_not_snapshotted_as_its
  - [+] test_its_saved_dsp_cannot_be_reset_meanwhile
  - [+] test_its_saved_dsp_resets_as_before_otherwise
  - [+] test_the_route_says_why_it_refuses[True-503] (0.03s)
  - [+] test_the_route_says_why_it_refuses[False-200] (0.03s)
  - [+] test_removing_it_does_not_stop_the_box_own
  - [+] test_choosing_another_keeps_the_box_own_identity

**tests.test_hqplayer_local_instance.TestIdentity**

  - [+] test_an_identity_is_kept_with_its_instance
  - [+] test_another_instance_s_identity_is_not_served
  - [+] test_an_answer_for_a_target_that_moved_is_not_kept
  - [+] test_a_read_in_flight_for_one_instance_is_not_handed_to_the_other
  - [+] test_the_naa_follows_the_card_s_instance_never_the_box_own
  - [+] test_the_card_s_major_is_kept_a_while
...
**tests.test_hqplayer_local_instance.TestTheConnection**
  ...
  - [+] test_the_box_own_with_the_card_s_choice_alongside
...
**tests.test_hqplayer_staged_push.TestStaging**
  ...
  - [+] test_plays_the_first_track_then_appends_the_rest
  - [+] test_keeps_the_album_order
  - [+] test_answers_for_the_whole_album_without_inventing_a_verdict
  - [+] test_says_nothing_was_queued_when_the_first_track_could_not_be_read_back
  - [+] test_a_failure_on_the_rest_never_reaches_the_caller

**tests.test_hqplayer_staged_push.TestWhenStagingDoesNotApply**

  - [+] test_a_single_track_goes_out_in_one_push (0.01s)
  - [+] test_an_append_is_never_staged (0.01s)
  - [+] test_an_ordinary_album_still_goes_out_in_one_push

**tests.test_hqplayer_staged_push.TestANewerPushWins**

  - [+] test_cancels_an_album_that_is_still_filling_in
  - [+] test_waits_for_the_cancelled_one_to_let_go
  - [+] test_a_remainder_created_while_we_queue_for_the_lock_is_dropped_too
  - [+] test_stopping_drops_the_rest_of_the_album
  - [+] test_a_finished_remainder_costs_nothing (0.01s)
...
**tests.test_library.TestUnknownSourceIsNotAnEmptyOne**
  ...
  - [+] test_a_real_source_with_no_local_catalogue_answers_empty_albums (0.19s)
  - [+] test_a_real_source_with_no_local_catalogue_answers_empty_search (0.18s)

**tests.test_library.TestTheRefreshParameterReachesTheService**

  - [+] test_refresh_true_is_forwarded (0.17s)
  - [+] test_an_ordinary_page_asks_for_no_refresh (0.19s)
...
**tests.test_library.TestUpnpQueueRouting**
  ...
  - [+] test_an_unclassified_source_is_refused_with_501 (0.41s)
...
**tests.test_library.TestResolveOutput**
  ...
  - [+] test_the_box_own_hqplayer_needs_no_naa
  - [+] test_the_target_is_known_before_it_is_read
  ...
  - [+] test_refuses_when_the_two_major_lines_do_not_match
  - [+] test_an_unknown_pairing_never_blocks_a_play
...
**tests.test_library.TestQueueRefusalHttpContract**
  ...
  - [+] test_upnp_play_refusal_is_a_503_with_mpds_reason (0.18s)
  - [+] test_remove_refusal_is_a_503_with_mpds_reason (0.18s)
...
**tests.test_library.TestUpnpDurationSurvivesTheTrip**
  ...
  - [+] test_search_maps_it_on_BOTH_branches (0.01s)
...
**tests.test_library.TestStoppedMpdIsNamedByTheRoutes**
  ...
  - [+] test_the_queue_says_it_too (0.22s)
  - [+] test_another_kind_of_unreachable_still_answers_an_empty_list (0.17s)
  - [+] test_the_status_is_503_not_500 (0.18s)
...
**tests.test_library.TestTheErrorContractIsTheSameOnEveryProviderRoute**
  ...
  - [+] test_an_unexpected_failure_names_the_service (0.19s)
...
**tests.test_library_album_sort.TestRefreshIntent**

  - [+] test_changing_the_order_does_not_re_scan_mpd
  - [+] test_the_cached_list_still_answers_in_the_requested_order
  - [+] test_refresh_re_scans
  - [+] test_the_first_page_alone_no_longer_re_scans
  - [+] test_readers_arriving_together_share_one_walk
  - [+] test_a_refresh_joining_a_running_walk_does_not_start_a_second
  - [+] test_a_refresh_on_one_artist_leaves_the_other_lists_alone

**tests.test_library_album_sort.TestDatabaseStamp**

  - [+] test_an_unchanged_library_is_never_walked_twice
  - [+] test_a_re_indexed_library_is_seen_on_the_next_request
  - [+] test_a_stamped_list_outlives_the_minute_it_used_to_be_thrown_away_after
  - [+] test_the_stamp_probe_is_bounded
  - [+] test_the_two_lifetimes_say_what_they_are_for
  - [+] test_a_failed_refresh_leaves_the_previous_list_in_place
  - [+] test_a_refresh_does_not_join_a_walk_that_began_before_the_change
  - [+] test_a_daemon_publishing_no_stamp_keeps_the_old_blind_lifetime
  - [+] test_a_stamp_of_zero_is_not_a_stamp
  - [+] test_a_stopped_daemon_is_an_error_rather_than_an_old_list
...
**tests.test_library_files.TestResolveWithinRoots**
  ...
  - [+] test_symlink_pointing_outside_the_root_is_rejected
...
**tests.test_library_files.TestStreamEndpoint**
  ...
  - [+] test_full_get_returns_all_bytes (0.45s)
  - [+] test_range_returns_206_partial (0.17s)
  - [+] test_head_returns_headers_no_body (0.17s)
  - [+] test_bad_signature_rejected (0.17s)
  - [+] test_missing_signature_rejected (0.18s)
  - [+] test_missing_file_returns_404 (0.21s)

**tests.test_library_files.TestSignedUrls**

  - [+] test_the_address_is_detected_and_the_port_is_the_one_listened_on
  - [+] test_a_base_computed_for_the_device_is_used_as_is
  ...
  - [+] test_the_route_serves_the_url_it_was_handed[Bj\xf6rk/Homogenic/01 Hunter.dsf-library_stream_url] (0.21s)
  - [+] test_the_route_serves_the_url_it_was_handed[Bj\xf6rk/Homogenic/01 Hunter.dsf-library_signed_path_url] (0.20s)
  ...
  - [+] test_the_route_serves_the_url_it_was_handed[x/100%2F200.flac-library_stream_url] (0.19s)
...
**tests.test_library_files.TestHqplayerGetsMp3WithoutItsTag**
  ...
  - [+] test_renderers_still_get_the_file_as_it_is (0.25s)
...
**tests.test_library_files.TestTheSignedRoutesNeedNoApiKey**
  ...
  - [+] test_a_signed_url_passes_the_real_guard (0.18s)

**tests.test_library_files.TestServeFileContentType**

  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.flac-audio/flac]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.wav-audio/x-wav]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.aif-audio/x-aiff]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.aiff-audio/x-aiff]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.mp3-audio/mpeg]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.dsf-audio/x-dsf]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[T.DSF-audio/x-dsf]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.dff-audio/x-dff]
  - [+] test_audio_formats_are_announced_by_ag_not_the_platform[t.wv-audio/x-wavpack]
  - [+] test_other_formats_keep_the_platform_value
  - [+] test_a_path_that_reads_as_a_url_keeps_its_type
  - [+] test_an_unknown_extension_is_plain_bytes
...
**tests.test_library_flac.TestWhichFilesAreConverted**
  ...
  - [+] test_converts_what_hqplayer_cannot_decode[a.m4a]
  - [+] test_converts_what_hqplayer_cannot_decode[a.M4A]
  - [+] test_converts_what_hqplayer_cannot_decode[a.mp4]
  - [+] test_converts_what_hqplayer_cannot_decode[a.ogg]
  - [+] test_converts_what_hqplayer_cannot_decode[a.opus]
  - [+] test_converts_what_hqplayer_cannot_decode[a.wma]
  - [+] test_converts_what_hqplayer_cannot_decode[a.ape]
  - [+] test_converts_what_hqplayer_cannot_decode[a.aac]
  - [+] test_converts_what_hqplayer_cannot_decode[Artist/Album/01 Song.m4a]
  - [+] test_leaves_alone_what_it_can[a.flac]
  - [+] test_leaves_alone_what_it_can[a.wav]
  - [+] test_leaves_alone_what_it_can[a.aiff]
  - [+] test_leaves_alone_what_it_can[a.mp3]
  - [+] test_leaves_alone_what_it_can[a.wv]
  - [+] test_leaves_alone_what_it_can[a]
  - [+] test_never_converts_dsd[a.dsf]
  - [+] test_never_converts_dsd[a.dff]
  - [+] test_the_two_lists_agree

**tests.test_library_flac.TestTheUrl**
...
**tests.test_library_flac.TestHowMuchTheCacheMayHold**
  ...
  - [+] test_takes_a_share_of_what_is_actually_free
  - [+] test_never_more_than_the_ceiling
  - [+] test_never_less_than_one_useful_album
  - [+] test_survives_a_disk_it_cannot_read

**tests.test_library_flac.TestTheCacheKey**

  - [+] test_changes_when_the_file_does
  - [+] test_differs_between_two_paths
  - [+] test_is_usable_as_a_file_name
  - [+] test_survives_an_unreadable_source
...
**tests.test_library_flac.TestConverting**
  ...
  - [+] test_converts_once_for_two_simultaneous_requests (0.26s)
  ...
  - [+] test_forgets_the_conversion_once_it_is_done (0.28s)
  - [+] test_a_probe_that_gives_up_does_not_cancel_the_conversion (0.26s)

**tests.test_library_flac.TestTheRoute**

  - [+] test_head_announces_a_size_and_byte_ranges (0.44s)
  - [+] test_serves_a_byte_range (0.40s)
  - [+] test_refuses_a_bad_signature (0.27s)
  - [+] test_refuses_a_signature_made_for_another_file (0.39s)
  - [+] test_refuses_a_path_that_escapes_the_library (0.51s)
  - [+] test_reports_a_missing_file (0.16s)
  - [+] test_reports_a_conversion_that_failed (0.29s)
...
**tests.test_library_playlists_router.TestListing**
  ...
  - [+] test_the_account_playlists_are_listed (0.19s)
  - [+] test_a_source_not_written_yet_is_a_bad_request_saying_which (0.18s)
  - [+] test_the_source_is_required (0.17s)

**tests.test_library_playlists_router.TestCreation**

  - [+] test_a_playlist_is_created (0.17s)
  - [+] test_a_name_out_of_bounds_is_refused_before_the_service[] (0.27s)
  - [+] test_a_name_out_of_bounds_is_refused_before_the_service[xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx] (0.22s)
  - [+] test_a_refusal_is_a_bad_request (0.33s)

**tests.test_library_playlists_router.TestAdding**

  - [+] test_the_counts_come_back (0.17s)
  - [+] test_only_tracks_and_albums_can_be_added (0.23s)
  - [+] test_a_refused_item_is_a_bad_request (0.16s)
  - [+] test_a_slow_provider_is_not_blamed_on_the_box (0.17s)
  - [+] test_a_refusal_from_the_provider_says_its_reason (0.21s)

**tests.test_library_playlists_router.TestGuests**

  - [+] test_every_write_is_closed_to_guests (0.17s)
  - [+] test_a_playlist_s_tracks_are_read_like_the_rest_of_the_browse (0.46s)

**tests.test_library_playlists_router.TestStep2Routes**

  - [+] test_a_track_is_removed (0.19s)
  - [+] test_a_playlist_is_renamed_with_its_description (0.21s)
  - [+] test_a_rename_that_names_no_description_asks_to_keep_it (0.18s)
  - [+] test_a_missing_account_playlist_s_tracks_are_a_bad_request (0.24s)
  - [+] test_a_failed_read_of_the_tracks_is_the_provider_s (0.28s)
  - [+] test_the_older_tracks_route_refuses_a_missing_playlist_too (0.18s)
  - [+] test_a_start_the_path_would_drop_is_refused_before_anything_plays (0.18s)
  - [+] test_a_rename_without_a_name_never_reaches_the_service (0.16s)
  - [+] test_a_playlist_is_deleted (0.17s)
  - [+] test_the_tracks_are_listed (0.26s)
  - [+] test_a_refusal_is_a_bad_request_with_its_reason[<lambda>0] (0.25s)
  - [+] test_a_refusal_is_a_bad_request_with_its_reason[<lambda>1] (0.19s)
  - [+] test_a_refusal_is_a_bad_request_with_its_reason[<lambda>2] (0.23s)
...
**tests.test_license.TestTimeLimitedLicenceContract**
  ...
  - [+] test_a_forged_licence_is_told_apart_from_an_expired_one
  ...
  - [+] test_expiry_takes_effect_without_a_restart
...
**tests.test_license.TestDeleteLicense**
  ...
  - [+] test_delete_wrong_password (0.35s)
  - [+] test_delete_no_license (0.02s)
  - [+] test_no_name_error (0.07s)
...
**tests.test_license.TestCheckEndpointStatusHandling**
  ...
  - [+] test_server_5xx_returns_502 (0.05s)
...
**tests.test_log_space.TestDeclaration**

  - [+] test_a_complete_declaration_is_used
  - [+] test_an_incomplete_one_is_ignored[change0]
  - [+] test_an_incomplete_one_is_ignored[change1]
  - [+] test_an_incomplete_one_is_ignored[change2]
  - [+] test_an_incomplete_one_is_ignored[change3]
  - [+] test_an_incomplete_one_is_ignored[change4]
  - [+] test_an_incomplete_one_is_ignored[change5]
  - [+] test_no_block_is_no_space
  - [+] test_the_log_path

**tests.test_log_space.TestUnits**

  - [+] test_the_mount_is_a_tmpfs_of_the_declared_size
  - [+] test_the_service_waits_for_the_space_and_trims_its_log

**tests.test_log_space.TestSetAttribute**
  ...
  - [+] test_a_longer_name_is_not_the_element
  - [+] test_an_absent_element_is_refused
  - [+] test_an_element_mentioned_in_a_comment_too_is_refused
  - [+] test_a_document_that_no_longer_parses_is_refused
...
**tests.test_log_space.TestApply**
  ...
  - [+] test_a_space_that_went_down_is_brought_back (0.02s)
  - [+] test_without_a_unit_the_service_is_not_tied (0.01s)
  - [+] test_a_mount_that_fails_ties_nothing_and_leaves_the_config (0.01s)
  - [+] test_a_full_tmp_is_a_failure_said_not_an_exception (0.01s)
  - [+] test_a_drop_in_directory_that_cannot_be_made_is_said (0.02s)
  - [+] test_a_config_that_cannot_be_written_is_left_whole (0.01s)
  - [+] test_the_log_says_it_once (0.01s)
  - [+] test_a_write_cut_short_never_reaches_the_config (0.01s)
  - [+] test_a_config_without_the_element_is_not_touched (0.01s)
  - [+] test_an_unknown_group_stops_before_anything_is_written

**tests.test_log_space.TestRemove**

  - [+] test_the_space_and_the_drop_in_go (0.03s)
  - [+] test_the_services_tab_override_keeps_its_directory (0.02s)
  - [+] test_nothing_there_means_nothing_done_and_nothing_said_removed (0.01s)
  - [+] test_a_failure_is_reported_never_raised (0.02s)
  - [+] test_a_unit_name_that_cannot_be_derived_leaves_it_in_place (0.01s)
  - [+] test_even_an_unexpected_error_is_not_raised
  - [+] test_the_vendor_config_keeps_pointing_at_the_space (0.02s)
...
**tests.test_log_space.TestThroughTheManager**
  ...
  - [+] test_an_unexpected_error_in_a_step_is_that_step_only (0.05s)
  - [+] test_the_reason_reaches_the_cores_own_log (0.06s)
  - [+] test_an_update_gives_an_older_install_its_space (0.04s)
  - [+] test_an_update_of_an_equipped_box_runs_nothing_privileged (0.09s)
  - [+] test_the_space_goes_after_the_package (0.05s)
  - [+] test_a_dry_run_touches_nothing (0.01s)
...
**tests.test_migrate_audio_config.TestBackupDirectory**
  ...
  - [+] test_the_backups_move_to_the_new_id
  - [+] test_the_old_name_becomes_a_link_for_a_rolled_back_core
  - [+] test_a_new_directory_the_new_core_already_created_is_merged
  - [+] test_it_does_nothing_twice
  - [+] test_a_name_clash_keeps_both_files
  - [+] test_nothing_to_move_is_nothing_to_do
...
**tests.test_minimal_configs**
  ...
  - [+] test_upmpdcli_minimal_content_and_roundtrip (0.01s)
  - [+] test_shairport_minimal_content_and_roundtrip (0.02s)
...
**tests.test_mpd_client.TestStoppedDaemonIsNamed**
  ...
  - [+] test_a_refused_connection_says_what_to_do (1.01s)
...
**tests.test_net**
  ...
  - [+] test_is_local_host_names_the_box
  - [+] test_is_local_host_empty_is_never_local_even_without_detection
  ...
  - [+] test_a_probed_route_still_wins_over_a_remembered_address
  - [+] test_an_ipv4_peer_that_lost_its_route_does_not_fall_back_on_a_memory
  - [+] test_a_loopback_address_is_never_handed_to_a_device
  - [+] test_an_ipv6_address_seen_on_the_connection_is_not_used
  - [+] test_get_local_ip_is_cached_until_asked_to_probe_again
  - [+] test_a_failed_probe_is_not_cached
  - [+] test_every_probe_goes_through_one_helper
  - [+] test_a_listening_ipv4_socket_is_found
  - [+] test_a_listening_ipv6_socket_is_found
  - [+] test_a_connection_on_the_port_is_not_a_listener
  - [+] test_another_port_listening_is_not_this_one
...
**tests.test_no_lab_addresses**
  ...
  - [+] test_no_test_hardcodes_a_host_address (0.12s)
...
**tests.test_now_playing.TestExtStreamKey**
  ...
  - [+] test_local_file_returns_path_as_key (0.01s)

**tests.test_now_playing.TestContentSourceId**

  - [+] test_a_upnp_stream_names_its_server
  - [+] test_two_servers_sharing_a_name_are_told_apart
  - [+] test_a_server_registered_without_an_id_names_none
  - [+] test_content_carried_over_another_transport_names_its_own_source[qobuz-src_qobuz]
  - [+] test_content_carried_over_another_transport_names_its_own_source[tidal-src_tidal]
  - [+] test_content_carried_over_another_transport_names_its_own_source[highresaudio-src_highresaudio]
  - [+] test_content_carried_over_another_transport_names_its_own_source[radio-src_radio]
  - [+] test_local_music_names_the_library_wherever_it_is_played
  - [+] test_a_source_carrying_its_own_content_answers_itself[roon-src_mono-sgen]
...
**tests.test_now_playing.TestContentItemId**
  ...
  - [+] test_a_highresaudio_track_is_named_by_its_playlist_id[http://127.0.0.1:8000/highresaudio/stream/50198d00-cd23-4ea0-82b7-da1b2da89b17_cfe9636e-8d3b-4433-9258-352ddaec4d2c?api_key=k&mode=redirect]
  - [+] test_a_highresaudio_track_is_named_by_its_playlist_id[http://192.168.1.20:8000/highresaudio/stream/50198d00-cd23-4ea0-82b7-da1b2da89b17_cfe9636e-8d3b-4433-9258-352ddaec4d2c?mode=redirect]
  - [+] test_a_highresaudio_track_is_named_by_its_playlist_id[http://192.168.1.20:8000/highresaudio/stream/50198d00-cd23-4ea0-82b7-da1b2da89b17_cfe9636e-8d3b-4433-9258-352ddaec4d2c]
  - [+] test_the_other_streaming_services_are_named_the_same_way
  ...
  - [+] test_no_url_or_no_origin_names_nothing
  - [+] test_surrounding_whitespace_is_ignored
  - [+] test_an_encoded_id_is_decoded
  - [+] test_the_stream_key_is_unchanged_by_the_shared_reading
...
**tests.test_now_playing.TestRendererAsSource**
  ...
  - [+] test_a_cast_media_server_track_names_no_track (0.01s)
  ...
  - [+] test_control_next_seek_volume (0.01s)
...
**tests.test_packages.TestAptDebSingle**
  ...
  - [+] test_a_normal_install_logs_no_error
...
**tests.test_packages.TestVersionAndNoticeRoutes**

  - [+] test_versions_split_what_installs_from_what_cannot (0.03s)
  - [+] test_notices_say_when_they_could_not_be_read (0.05s)
  - [+] test_an_unpublished_version_is_a_400 (0.07s)
  - [+] test_an_unknown_package_is_a_404 (0.09s)
...
**tests.test_packages.TestCommandOutputStreaming**
  ...
  - [+] test_reading_the_log_while_a_worker_appends_never_raises (0.14s)
...
**tests.test_packages.TestAptSimpleProbe**
  ...
  - [+] test_architecture_all_is_kept_as_is (0.01s)
...
**tests.test_packages.TestVersionsFromTheSourceItself**
  ...
  - [+] test_the_installers_answer_wins_over_apt (4.12s)
...
**tests.test_packages.TestAptListsAreRefreshedBeforeBeingRead**
  ...
  - [+] test_stale_lists_are_refreshed (0.01s)
  - [+] test_the_invocation_matches_what_sudoers_grants (0.01s)
...
**tests.test_packages.TestDebVersionSelection**

  - [+] test_parse_version_orders_what_it_accepts
  - [+] test_parse_version_refuses_what_it_cannot_rank
  - [+] test_select_ignores_page_order
  - [+] test_select_compares_numerically_not_as_text
  - [+] test_select_holds_the_required_major
  - [+] test_select_returns_none_when_the_line_is_absent
  - [+] test_select_skips_what_it_cannot_parse
  - [+] test_stays_on_the_installed_major
  - [+] test_takes_the_newest_when_nothing_is_installed
  - [+] test_refuses_rather_than_crossing_lines
  - [+] test_the_line_is_held_per_architecture
  - [+] test_package_name_comes_from_the_config

**tests.test_packages.TestInstalledVersionReader**

  - [+] test_reports_an_installed_version
  - [+] test_ignores_a_removed_package
  - [+] test_absent_package_is_not_an_error

**tests.test_packages.TestVersionSelectionEdgeCases**

  - [+] test_refuses_when_the_installed_version_cannot_be_read[not-a-version]
  - [+] test_refuses_when_the_installed_version_cannot_be_read[nightly]
  - [+] test_refuses_when_the_installed_version_cannot_be_read[?]
  - [+] test_real_debian_versions_keep_the_pin[1:5.1.8-68-5]
  - [+] test_real_debian_versions_keep_the_pin[5.1.8-68+deb13u1-5]
  - [+] test_real_debian_versions_keep_the_pin[5.1.8-68~bpo12+1-5]
  - [+] test_real_debian_versions_keep_the_pin[5.2-70-5]
  - [+] test_real_debian_versions_keep_the_pin[5.1.8.2-70-5]
  - [+] test_a_package_without_pin_major_is_not_held
  - [+] test_refuses_to_search_without_a_package_name
  - [+] test_unreadable_candidates_are_not_blamed_on_the_major_line
  - [+] test_an_absent_line_says_so_plainly
  - [+] test_the_failure_is_logged_even_when_the_operation_log_is_off
  - [+] test_epoch_outranks_everything
  - [+] test_a_backport_sorts_below_its_release
  - [+] test_versions_of_any_length_rank

**tests.test_packages.TestDpkgStatusReading**

  - [+] test_only_the_status_word_decides[install ok installed-True]
  - [+] test_only_the_status_word_decides[install ok triggers-pending-True]
  - [+] test_only_the_status_word_decides[install ok triggers-awaited-True]
  - [+] test_only_the_status_word_decides[install ok half-configured-True]
  - [+] test_only_the_status_word_decides[install ok half-installed-False]
  - [+] test_only_the_status_word_decides[install ok unpacked-False]
  - [+] test_only_the_status_word_decides[deinstall ok config-files-False]
  - [+] test_only_the_status_word_decides[unknown ok not-installed-False]
  - [+] test_only_the_status_word_decides[-False]

**tests.test_packages.TestAvailableVersionLookupIsOptional**

  - [+] test_false_asks_neither_apt_nor_the_vendor
...
**tests.test_packages.TestMajorProviderWiring**

  - [+] test_no_source_declared_means_no_provider
  - [+] test_an_unknown_source_is_refused_rather_than_guessed
  - [+] test_the_registry_names_a_source_the_service_knows
  - [+] test_the_provider_says_nothing_when_the_module_is_absent

**tests.test_packages.TestWhichWayTheOfferedVersionGoes**

  - [+] test_the_comparison[5.1.8-68-6.1.4-71-True]
  - [+] test_the_comparison[6.1.4-71-5.1.8-68-False]
  - [+] test_the_comparison[5.1.8-68-5.1.8-68-False]
  - [+] test_the_comparison[1:1.0-1-9.9.9-9-False]
  - [+] test_the_comparison[5.1.8-68~bpo12+1-5.1.8-68-True]
  - [+] test_the_comparison[None-5.1.8-68-None]
  - [+] test_the_comparison[5.1.8-68-None-None]
  - [+] test_the_comparison[nightly-5.1.8-68-None]
  - [+] test_the_api_carries_the_direction
  - [+] test_an_unreadable_version_leaves_the_direction_unknown

**tests.test_packages.TestTheProviderActuallyAsksHqplayer**

  - [+] test_it_returns_the_configured_hqplayers_major

**tests.test_packages.TestUpdateNotificationsSkipARepairDowngrade**

  - [+] test_a_newer_version_is_announced
  - [+] test_an_older_version_is_not
  - [+] test_an_unreadable_pair_wakes_nobody

**tests.test_packages.TestMatchMount**

  - [+] test_the_longest_mount_point_wins
  - [+] test_a_mount_point_matches_itself
  - [+] test_a_name_that_merely_starts_the_same_is_not_a_match
  - [+] test_nothing_matching_gives_none
  - [+] test_it_skips_malformed_rows

**tests.test_packages.TestDownloadDir**

  - [+] test_tmpdir_wins_when_it_is_set
  - [+] test_a_tmpdir_that_does_not_exist_is_ignored
  - [+] test_a_disk_backed_candidate_is_preferred_over_ram
  - [+] test_it_still_returns_something_when_every_candidate_is_ram
  - [+] test_an_unknown_filesystem_is_accepted_rather_than_rejected
  - [+] test_a_candidate_that_does_not_exist_is_skipped

**tests.test_packages.TestInstallSpaceCheck**

  - [+] test_it_refuses_when_the_unpack_does_not_fit
  - [+] test_the_refusal_gives_both_figures
  - [+] test_the_unpack_is_measured_with_roots_figure
  - [+] test_a_download_on_the_same_disk_counts_against_the_unpack
  - [+] test_a_download_on_another_disk_does_not
  - [+] test_the_download_itself_needs_the_users_room
  - [+] test_a_package_that_declares_no_size_is_let_through
  - [+] test_a_filesystem_it_cannot_measure_is_let_through
  - [+] test_a_bundle_is_measured_as_a_whole (0.02s)
  - [+] test_a_damaged_download_is_let_through_not_failed
...
**tests.test_packages.TestUninstallPurge**
  ...
  - [+] test_a_plain_uninstall_does_not_purge
  - [+] test_purge_is_asked_for_explicitly
  - [+] test_purging_warns_that_data_goes
  - [+] test_every_installer_accepts_the_flag

**tests.test_packages.TestVersionChoice**

  - [+] test_it_offers_the_newest_build_of_each_major_line
  - [+] test_a_line_whose_header_cannot_be_read_is_undecided_not_hidden
  ...
  - [+] test_a_version_the_vendor_withdrew_is_refused
  - [+] test_without_a_choice_it_behaves_as_before
  - [+] test_only_the_deb_installer_says_it_can_honour_a_version
  - [+] test_every_installer_accepts_the_version_argument
  - [+] test_the_base_installer_offers_no_versions

**tests.test_packages.TestVendorNotices**

  - [+] test_it_returns_the_licence_the_install_would_skip (0.01s)
  - [+] test_a_body_delivered_in_pieces_is_read_to_the_end (0.01s)
  - [+] test_a_control_member_past_the_first_slice_is_fetched_in_full (0.15s)
...
**tests.test_packages.TestVersionChoiceThroughTheManager**
  ...
  - [+] test_the_chosen_version_reaches_the_installer (0.05s)
  - [+] test_a_version_is_refused_for_an_installer_that_cannot_honour_it
  - [+] test_a_version_is_refused_for_a_package_that_offers_no_choice
  - [+] test_installing_without_a_version_still_works (0.06s)
...
**tests.test_player.TestSourceKindAndContentOnlySources**

  - [+] test_each_pipeline_source_declares_what_it_is[src_mpd-library]
  - [+] test_each_pipeline_source_declares_what_it_is[src_mono-sgen-roon]
  - [+] test_each_pipeline_source_declares_what_it_is[src_shairport-sync-input]
  - [+] test_a_source_is_named_by_what_it_is_not_by_its_daemon[src_mpd-Local Library]
  - [+] test_a_source_is_named_by_what_it_is_not_by_its_daemon[src_mono-sgen-Roon]
  - [+] test_a_source_is_named_by_what_it_is_not_by_its_daemon[src_shairport-sync-AirPlay]
  - [+] test_a_routing_handle_declares_no_kind[upnp_renderer]
  - [+] test_a_routing_handle_declares_no_kind[src_hqplayer]
  ...
  - [+] test_an_optional_service_answers_none_without_building_an_exception
  - [+] test_a_disabled_module_is_not_offered_and_does_not_raise
  - [+] test_the_active_flag_stays_on_the_transport_while_a_station_plays

**tests.test_player.TestSseChangeDetection**

  - [+] test_a_second_stream_starting_is_published
  - [+] test_an_unfollowed_source_changing_content_is_published
  - [+] test_an_unfollowed_source_pausing_is_published
...
**tests.test_player.TestDsdRekeyOnDriver**
  ...
  - [+] test_dsd_start_on_cast_skips_software_forcing (0.01s)
...
**tests.test_post_install.TestDeclaration**
  ...
  - [+] test_a_unit_is_needed

**tests.test_post_install.TestRestartWhenReady**

  - [+] test_the_restart_waits_until_the_port_is_open
  - [+] test_a_service_that_is_not_running_is_left_alone
  - [+] test_a_port_that_never_opens_still_ends_in_a_restart (0.06s)
  - [+] test_without_a_port_the_restart_does_not_wait
  - [+] test_a_failed_restart_says_what_to_type
  - [+] test_the_reason_is_logged
  - [+] test_the_wait_ends_at_its_bound (0.06s)

**tests.test_post_install.TestRunnerForReal**

  - [+] test_it_returns_the_exit_code_and_the_output
  - [+] test_input_reaches_the_command (0.01s)
  - [+] test_without_input_stdin_is_closed
  - [+] test_a_command_that_hangs_is_given_up (0.21s)
  - [+] test_a_command_that_cannot_start_is_a_failure_not_an_exception

**tests.test_post_install.TestEnableAndStart**

  - [+] test_a_service_already_on_is_left_alone
  - [+] test_a_reinstall_left_off_is_turned_on
  - [+] test_a_running_but_disabled_one_is_enabled_without_counting_as_started
  - [+] test_a_failure_says_what_to_type

**tests.test_post_install.TestUnitFiles**

  - [+] test_a_file_is_written_once_then_left_alone
  - [+] test_a_different_content_is_written_again (0.01s)
  - [+] test_a_file_that_is_not_there_is_not_removed
  - [+] test_the_state_is_asked_without_privilege (0.01s)

**tests.test_post_install.TestBoundStop**

  - [+] test_the_bound_is_written_and_loaded (0.01s)
  - [+] test_a_second_time_runs_nothing (0.01s)
  - [+] test_without_a_usable_bound_nothing_is_written[None] (0.01s)
  - [+] test_without_a_usable_bound_nothing_is_written[0] (0.01s)
  - [+] test_without_a_usable_bound_nothing_is_written[-5] (0.01s)
  - [+] test_without_a_usable_bound_nothing_is_written[15]
  - [+] test_without_a_usable_bound_nothing_is_written[True]
  - [+] test_a_failure_is_a_warning_in_the_log_only
...
**tests.test_proc.TestRunBounded**
  ...
  - [+] test_exit_code_and_both_streams
  - [+] test_merged_streams_keep_their_order
  - [+] test_input_reaches_the_command
  - [+] test_without_input_stdin_is_closed
  - [+] test_a_command_that_cannot_start_is_an_answer
  - [+] test_the_environment_is_passed
  - [+] test_a_command_past_its_deadline_is_stopped (0.31s)
  - [+] test_a_child_holding_the_pipe_does_not_hold_the_caller (0.53s)
...
**tests.test_profiles.TestStopListServiceNotInstalled**
  ...
  - [+] test_its_own_profile_is_unavailable
...
**tests.test_provisioning**
  ...
  - [+] test_patch_output_raises_when_output_absent (0.01s)
  - [+] test_patch_library_changes_music_directory_only (0.02s)
  ...
  - [+] test_status_leaves_out_an_hqplayerd_the_box_does_not_declare
  ...
  - [+] test_patch_library_rescan_uses_configured_port (0.01s)
  ...
  - [+] test_rescan_detaches_retry_when_mpd_not_ready (0.01s)

**tests.test_provisioning.TestNoLibraryIsAllowed**

  - [+] test_provisioning_succeeds_with_no_library_at_all (0.04s)
  - [+] test_the_generated_mpd_config_omits_the_directive (0.01s)
...
**tests.test_provisioning.TestAWrongLibraryIsRefused**
  ...
  - [+] test_a_file_is_not_a_library (0.01s)
...
**tests.test_qobuz.TestQobuzOAuthEdgeCases**
  ...
  - [+] test_user_id_is_none_when_id_key_absent (0.01s)

**tests.test_qobuz.TestSignedFileUrlParams**

  - [+] test_the_signature_is_the_documented_string
  - [+] test_the_five_parameters_are_all_there
  - [+] test_the_timestamp_signed_is_the_timestamp_sent
  - [+] test_each_call_takes_its_own_timestamp
  - [+] test_the_secret_signed_is_the_one_passed_not_the_one_stored
...
**tests.test_qobuz.TestQobuzSubscription**
...
**tests.test_qobuz.TestABodyThatIsNotAUserObject**
  ...
  - [+] test_a_missing_credential_is_unknown_not_lapsed
  - [+] test_a_credential_without_rights_is_still_a_real_answer
...
**tests.test_qobuz_library.TestQobuzLibraryRouter**
  ...
  - [+] test_shelves (0.17s)
  - [+] test_genres (0.17s)
  - [+] test_genre_grid (0.44s)
  - [+] test_genre_requires_a_path (0.16s)
  - [+] test_purchases (0.16s)
  - [+] test_playlists_default_to_the_editorial_tree (0.19s)
  - [+] test_playlists_can_ask_for_the_account_tree (0.27s)
  - [+] test_playlists_refuse_an_unknown_tree (0.21s)
  - [+] test_featured_albums (0.20s)
  - [+] test_featured_albums_default_type (0.20s)
  - [+] test_playlists (0.20s)
  - [+] test_playlist_tracks (0.26s)
  - [+] test_playlist_tracks_missing_id (0.17s)
  - [+] test_featured_service_error (0.16s)

**tests.test_qobuz_library.TestQobuzQueueHelper**

  - [+] test_adds_tracks_as_stable_redirect_proxy_urls (0.01s)
...
**tests.test_qobuz_library.TestQobuzGenres**
  ...
  - [+] test_path_is_the_opaque_id_not_a_title_path (0.01s)
  - [+] test_sub_genres_are_alphabetical (0.01s)
...
**tests.test_qobuz_library.TestQobuzUnknownShelf**
  ...
  - [+] test_the_route_answers_400_not_503 (0.26s)
...
**tests.test_radio.TestRadioHonoursOutputSelection**
  ...
  - [+] test_hqplayer_push_carries_the_radio_identity (0.01s)
...
**tests.test_radio.TestRadioHqplayerFailureIsNotA500**
  ...
  - [+] test_a_busy_dac_surfaces_as_a_routing_refusal (0.01s)
...
**tests.test_radio.TestRadioCodecGate**
  ...
  - [+] test_the_station_codec_is_forwarded_to_the_guard (0.02s)
  - [+] test_an_mp3_station_goes_through (0.29s)
  - [+] test_an_unknown_codec_is_still_attempted
...
**tests.test_radio_relay.TestTheUrl**
  ...
  - [+] test_ends_in_flac_so_hqplayer_picks_the_right_decoder
  - [+] test_signs_the_station_id
  - [+] test_quotes_an_awkward_id
  - [+] test_is_reachable_without_an_api_key
...
**tests.test_radio_relay.TestTheRoute**
  ...
  - [+] test_get_streams_flac (0.32s)
  - [+] test_get_announces_no_size (0.36s)
  - [+] test_refuses_a_bad_signature (0.18s)
  - [+] test_refuses_a_signature_made_for_another_station (0.22s)
...
**tests.test_renderer_manager.TestDisconnect**
  ...
  - [+] test_disconnect_clears_active_udn (0.01s)
...
**tests.test_roon_client.TestTheAttemptIsBounded**
  ...
  - [+] test_a_stuck_attempt_is_not_joined_by_another (0.02s)
...
**tests.test_roon_client.TestTheRetryBacksOff**
  ...
  - [+] test_waiting_for_the_owner_keeps_the_base_cadence (0.03s)
...
**tests.test_self_update.TestUpdateEndpoints**
  ...
  - [+] test_update_rejects_bad_password (0.06s)
...
**tests.test_services.TestOverrideWrite**
  ...
  - [+] test_the_override_lands_root_owned (0.02s)
  - [+] test_a_refused_move_is_reported_and_nothing_reloads
...
**tests.test_ssdp.TestMulticastFailureDoesNotCancelUnicast**
  ...
  - [+] test_unicast_probes_still_go_out (0.27s)
...
**tests.test_sse_channels**
  ...
  - [+] test_every_known_channel_passes_the_guard (0.05s)
...
**tests.test_stream_hqplayer.TestQueueRouteDispatch**
  ...
  - [+] test_a_media_server_item_goes_to_the_upnp_path (0.38s)
...
**tests.test_stream_meta.TestBuildStreamMeta**
  ...
  - [+] test_duration_normalisation[inf-None] (0.01s)
...
**tests.test_stream_meta.TestPersistence**
  ...
  - [+] test_first_write_after_restart_does_not_discard_prior_entries (0.01s)
...
**tests.test_streaming_provider.TestSubscriptionFields**

  - [+] test_defaults_are_unknown
  - [+] test_both_fields_are_documented

**tests.test_streaming_provider.TestSubscriptionTracker**
  ...
  - [+] test_apply_ignores_an_unknown
  - [+] test_unknown_reads_as_subscribed_before_anything_is_known
  - [+] test_invalidate_forgets_and_forces_a_re_read (0.01s)
  - [+] test_default_ttl_is_hours_not_minutes
  - [+] test_concurrent_callers_share_one_read
  - [+] test_it_survives_a_second_event_loop
...
**tests.test_support_report**
  ...
  - [+] test_secret_never_reaches_the_serialized_report[a secret in a trailing comment on an innocent directive] (0.01s)
  - [+] test_secret_never_reaches_the_serialized_report[api_key as an XML attribute (redacted as a directive, published as an attribute)] (0.02s)
  - [+] test_secret_never_reaches_the_serialized_report[a bare key attribute] (0.01s)
...
**tests.test_support_report.TestRunBounded**
  ...
  - [+] test_timeout_kills_and_reaps (0.21s)
  - [+] test_missing_binary_is_an_answer_not_a_raise (0.01s)

**tests.test_support_report.TestCollectStorage**

  - [+] test_groups_paths_by_mountpoint_with_ro_flag (0.02s)

**tests.test_support_report.TestCollectAudioTuning**

  - [+] test_configured_values_named_and_sentinels_dropped
  - [+] test_a_unit_that_does_not_exist_reports_no_tuning
  - [+] test_a_loaded_unit_is_reported_in_full
  - [+] test_named_policies_pass_through_on_newer_systemd

**tests.test_support_report.TestCollectNetwork**

  - [+] test_gateway_clock_and_probes_from_canned_output (0.01s)
...
**tests.test_support_report.TestAuthoritySummary**
  ...
  - [+] test_two_authorities_never_share_a_fingerprint (0.12s)
...
**tests.test_support_report.TestTheHQPlayerSection**
...
**tests.test_sysinfo.TestSysinfoGrepPatternValidation**
  ...
  - [+] test_invalid_regex_returns_400 (0.05s)
...
**tests.test_tidal.TestTidalSubscription**
  ...
  - [+] test_reads_premium_access_not_status
  - [+] test_reports_a_subscribed_account
...
**tests.test_tidal_library.TestTidalArtistAlbums**
  ...
  - [+] test_hits_artist_endpoint_and_maps (0.01s)
...
**tests.test_tidal_library.TestTidalBrowsableLists**
  ...
  - [+] test_an_unknown_path_yields_an_empty_grid_not_an_error (0.01s)
...
**tests.test_tidal_library.TestTidalListResilience**
  ...
  - [+] test_editorial_survives_a_dead_charts_page (0.01s)
...
**tests.test_tidal_library.TestTidalExplore**
  ...
  - [+] test_the_groups_are_flattened_in_tidal_s_own_order (0.02s)
  - [+] test_a_path_of_the_wrong_shape_never_enters_the_list (0.02s)
...
**tests.test_transcode.TestToFlacFile**
  ...
  - [+] test_converts_alac_to_a_complete_flac (0.38s)
  - [+] test_drops_a_cover_art_stream (0.41s)
...
**tests.test_transcode.TestFlacRelay**
  ...
  - [+] test_yields_flac_bytes (0.24s)
  - [+] test_kills_ffmpeg_when_the_listener_leaves (0.23s)
  - [+] test_kills_ffmpeg_when_the_listener_is_cancelled (0.40s)
  - [+] test_reports_a_missing_ffmpeg_rather_than_crashing
...
**tests.test_transcode.TestStartedStream**
  ...
  - [+] test_keeps_the_first_chunk_and_the_rest
  - [+] test_refuses_a_stream_that_produced_nothing
  - [+] test_refuses_a_stream_that_failed_at_once
  - [+] test_refuses_a_stream_that_stays_silent (0.06s)
  - [+] test_closes_the_source_it_refuses (0.06s)

**tests.test_transport_control.TestTransportActions**

  - [+] test_action_set_contents (0.01s)

**tests.test_transport_control.TestControlRouting**

  - [+] test_unknown_service_returns_false (0.01s)
  - [+] test_mpd_protocol_routes_to_control_mpd_and_invalidates
  - [+] test_failed_dispatch_does_not_invalidate (0.01s)
  - [+] test_failed_seek_still_invalidates (0.01s)
...
**tests.test_transport_control.TestControlMpdTruthfulness**
  ...
  - [+] test_volume_is_clamped (0.01s)
  - [+] test_never_raises (0.01s)
...
**tests.test_transport_seek**
  ...
  - [+] test_refused_tidal_seek_reopens_from_the_complete_cache (0.01s)
...
**tests.test_trial_override.TestRefreshTrialConfig**
  ...
  - [+] test_online_loop_fetches_and_caches_the_blob
...
**tests.test_upmpdcli_cover.TestLocalIps**
  ...
  - [+] test_this_box_is_known_by_its_address_on_the_route_out
  - [+] test_no_route_leaves_loopback_only
...
**tests.test_upnp_renderer.TestRendererServiceStatus**
  ...
  - [+] test_status_can_seek_false_when_unsupported (0.01s)
  - [+] test_status_dsd_uri_sets_format (0.02s)
...
**tests.test_upnp_renderer.TestMinimalDidl**
  ...
  - [+] test_empty_title_falls_back_to_uri (0.02s)

**tests.test_upnp_renderer.TestPublishStatus**

  - [+] test_publish_calls_event_bus (0.03s)
  - [+] test_publish_dedup_suppresses_identical_payload (0.01s)
  - [+] test_publish_skipped_when_no_event_bus
  - [+] test_disconnect_event_not_suppressed_by_previous_hash (0.01s)
...
**tests.test_upnp_renderer.TestPlayQueue**
  ...
  - [+] test_play_queue_empty_is_noop (0.02s)
  - [+] test_play_queue_preloads_second_track_via_set_next (0.02s)
  - [+] test_play_queue_no_set_next_when_not_supported (0.01s)
  - [+] test_play_queue_lazy_resolver_called_at_play_time (0.02s)
  - [+] test_play_queue_on_play_called_with_resolved_uri (0.02s)
  - [+] test_advance_queue_stopped_plays_next (0.01s)
...
**tests.test_utils_config_path.TestResolveConfigPath**
  ...
  - [+] test_subdirectory_below_the_prefix_is_preserved (0.01s)
  - [+] test_unchanged_when_nothing_found
  - [+] test_empty_path_passthrough
  - [+] test_etc_is_searched_before_usr_local (0.01s)

**tests.test_utils_mounts.TestUnescape**

  - [+] test_the_four_escapes_the_kernel_writes (0.01s)
  - [+] test_utf8_is_left_as_it_is (0.01s)
  - [+] test_a_field_without_escapes_is_unchanged

**tests.test_utils_mounts.TestParse**

  - [+] test_the_fields_are_decoded
  - [+] test_the_order_is_the_tables
  - [+] test_malformed_lines_are_skipped

**tests.test_utils_mounts.TestRead**
...
**tests.test_utils_owned_file.TestSetAttributeAroundComments**
  ...
  - [+] test_an_element_without_comments_is_edited_either_way

**tests.test_utils_owned_file.TestWriteFileAs**

  - [+] test_written_through_a_copy_as_its_owner
  - [+] test_a_refused_copy_leaves_the_file_as_it_was
  - [+] test_a_refused_rename_leaves_the_file_as_it_was
  - [+] test_a_copy_that_does_not_read_back_is_not_renamed
  - [+] test_windows_line_endings_are_written_and_read_back
  - [+] test_the_default_runner_is_core_s_one
...
**tests.test_utils_root_file.TestPlaceRootFile**

  - [+] test_moved_then_handed_to_root_then_made_readable
  - [+] test_a_step_after_the_move_that_fails_is_an_error[chown-is in place but could not be handed to root]
  - [+] test_a_step_after_the_move_that_fails_is_an_error[chmod-is in place but could not be made readable]
  - [+] test_a_refused_move_leaves_nothing_staged

**tests.test_utils_root_file.TestWriteRootFile**

  - [+] test_the_content_lands
  - [+] test_a_full_tmp_raises_and_leaves_no_half_file

**tests.test_utils_systemd.TestParseShowOutput**

  - [+] test_keeps_values_verbatim_sentinels_included
  - [+] test_splits_on_first_equal_only_and_skips_noise
  - [+] test_empty_output

**tests.test_utils_systemd.TestParseShowUnits**

  - [+] test_splits_units_on_repeated_id
  - [+] test_splits_units_on_any_repeated_key
  - [+] test_block_without_id_is_dropped
  - [+] test_empty_output

**tests.test_utils_systemd.TestIsUnset**

  - [+] test_every_spelling_of_no_value[None]
  - [+] test_every_spelling_of_no_value[]
  - [+] test_every_spelling_of_no_value[[not set]]
...
**tests.test_utils_systemd.TestIsInfinity**

  - [+] test_both_channels_spell_unlimited
  - [+] test_finite_or_absent_is_not_infinity[None]
  - [+] test_finite_or_absent_is_not_infinity[]
  - [+] test_finite_or_absent_is_not_infinity[[not set]]
  - [+] test_finite_or_absent_is_not_infinity[4110]
  - [+] test_finite_or_absent_is_not_infinity[0]

**tests.test_utils_systemd.TestIntOrNone**

  - [+] test_reads_numbers
  - [+] test_sentinels_and_garbage_are_none[None]
  - [+] test_sentinels_and_garbage_are_none[]
  - [+] test_sentinels_and_garbage_are_none[[not set]]
  - [+] test_sentinels_and_garbage_are_none[[no data]]
  - [+] test_sentinels_and_garbage_are_none[18446744073709551615]
  - [+] test_sentinels_and_garbage_are_none[abc]

**tests.test_utils_systemd.TestNamed**

  - [+] test_numbers_become_names
  - [+] test_names_pass_through
  - [+] test_unknown_number_is_kept_not_dropped
  - [+] test_no_value[None]
  - [+] test_no_value[]
...
**tests.test_web_credentials.TestPasswordRules**

  - [+] test_a_generated_password_is_accepted
  - [+] test_punctuation_is_accepted
  - [+] test_an_unusable_password_is_explained[short-at least 8] (0.01s)
  ...
  - [+] test_an_unusable_password_is_explained[-sneaky123-cannot start with a dash] (0.01s)
  - [+] test_the_bounds_themselves_are_accepted

**tests.test_web_credentials.TestDeclaration**

  - [+] test_a_complete_declaration_is_used
  - [+] test_an_incomplete_one_is_ignored[None]
  - [+] test_an_incomplete_one_is_ignored[yes]
  - [+] test_an_incomplete_one_is_ignored[block2]
  - [+] test_an_incomplete_one_is_ignored[block3] (0.01s)
  - [+] test_an_incomplete_one_is_ignored[block4]
  - [+] test_the_view_never_carries_the_command
  - [+] test_the_view_says_when_credentials_exist

**tests.test_web_credentials.TestApply**

  - [+] test_the_vendor_command_and_nothing_else
  - [+] test_the_password_is_never_logged_nor_returned
  - [+] test_a_failure_says_how_to_do_it_by_hand_without_the_password
  - [+] test_a_command_that_writes_nothing_is_a_failure
  - [+] test_the_command_run_and_the_one_told_are_built_alike
...
**tests.test_web_credentials.TestSetOnAnInstalledPackage**
  ...
  - [+] test_it_is_set_then_the_service_restarted (0.23s)
...
**tests.test_web_credentials.TestRoute**
  ...
  - [+] test_the_password_travels_in_the_body (0.03s)
  - [+] test_an_empty_body_sends_none (0.03s)
  - [+] test_no_body_at_all_still_installs (0.03s)
  - [+] test_a_password_in_the_query_string_is_not_read (0.04s)
  - [+] test_a_password_for_an_installed_package_travels_in_the_body (0.04s)
...
**tests.test_web_credentials.TestRegistry**
  ...
  - [+] test_the_command_is_what_sudoers_grants (0.06s)
...
**js/anti-zoom.test.js**
  ...
  - [+] field size tracks its label on touch > declares one ratio, for the one label step there is
  ...
  - [+] the sign-in page keeps its own field ratio > draws its field at its own label step, not at the app’s
  - [+] the sign-in page keeps its own field ratio > keeps the selector specific enough to beat the one in base.css
  - [+] the sign-in page keeps its own field ratio > gates it on the pointer, like the rule it overrides
...
**js/appearance.test.js**
  ...
  - [+] setDarkMode > stamps both elements, since the tokens and the theme rules read different ones (0.01s)
...
**js/auth.test.js**
  ...
  - [+] login() — the shape of a failure, which every sign-in message depends on > refused password: 401 with the core's detail (0.02s)
...
**js/colors.test.js**
  ...
  - [+] colours — components read roles, never values (règle 6) > keeps the base semantic tokens out of JavaScript, whatever route they take (0.08s)
...
**js/keyless-client.test.js**
  ...
  - [+] the probe: one request decides, instead of hundreds failing > locks after a single 403 and suppresses everything that follows (0.22s)
  ...
  - [+] the probe: one request decides, instead of hundreds failing > opens keyless traffic when the core proves it does not gate on a key (0.01s)
...
**js/layout-tokens.test.js**
  ...
  - [+] layout dimensions have one owner at phone width > finds the phone-width values where they actually apply
  - [+] layout dimensions have one owner at phone width > does not declare them a second time in themes.css
...
**js/layout-units.test.js**
  ...
  - [+] content running to the bottom of the screen keeps the mini-player's room > reserves it under the card grids, portrait and landscape, bar and column
  - [+] content running to the bottom of the screen keeps the mini-player's room > gives a tab bar its height back in a low window too
  - [+] content running to the bottom of the screen keeps the mini-player's room > reserves it under the library, in landscape as well as portrait
...
**js/library-api.test.js**
  ...
  - [+] queueItem > carries the position a playlist is played from
  - [+] queueItem > sends the first position too — 0 is a position, not an absence
  - [+] queueItem > names the track the position points at, so the core can find it if it moved
  - [+] queueItem > leaves the field out when no position is given
  ...
  - [+] playWithFeedback > names the tracks HQPlayer dropped, without calling the play a failure
  - [+] playWithFeedback > names the one track when only one was dropped
  - [+] playWithFeedback > still counts them when a CDN redirect hides which ones they were
  - [+] playWithFeedback > trails off rather than listing a whole album
  - [+] playWithFeedback > says nothing when every track was kept
  - [+] playWithFeedback > says nothing on a path that reports no refusals at all
  - [+] playWithFeedback > says it is working when the play takes longer than a moment
  - [+] playWithFeedback > stays silent for a play that comes back quickly
  - [+] playWithFeedback > does not leave the notice pending after a failure either
  ...
  - [+] playlist helpers > reads a playlist's tracks, and an answer that is not a list as none
  - [+] playlist helpers > creates without retrying, and announces the playlist made
  - [+] playlist helpers > announces an add only when something went in
  - [+] playlist helpers > announces a removal only when the track was there
  - [+] playlist helpers > renames with both fields, without retrying
  - [+] playlist helpers > sends no description when none is given — the core then keeps the current one
  - [+] playlist helpers > deletes without retrying — a retried deletion would answer "no longer exists"
  - [+] playlist helpers > announces nothing when a write fails
  - [+] playlist helpers > shows the core's own words for a failure, and a sentence when there are none
...
**js/library-store.test.js**
  ...
  - [+] hasSubscription > narrows only on an explicit false — absent, null and unknown all read as subscribed
...
**js/login-density.test.js**
  ...
  - [+] the sign-in page keeps its own steps > steps --font-size-lg down at phone width, as the theme used to
  - [+] the sign-in page keeps its own steps > is pinning steps the theme no longer carries
  - [+] why the page needs them > does not load the script that carried the compact class
  - [+] why the page needs them > is the only page that loads the stylesheet without the shell
...
**js/modal-paragraph-reset.test.js**
  ...
  - [+] modal paragraph reset > still resets plain paragraphs, so they do not take the browser margin
...
**js/net-errors.test.js**
  ...
  - [+] isGatewayError > recognises the measured case — a proxy 502 with an HTML body
  - [+] isGatewayError > recognises a 503 that carries no message either
  - [+] isGatewayError > recognises a 504 that carries no message either
  - [+] isGatewayError > claims a 502 whose detail is an EMPTY string
  - [+] isGatewayError > claims a 503 whose detail is an EMPTY string
  - [+] isGatewayError > claims a 504 whose detail is an EMPTY string
  - [+] isGatewayError > never claims a 502 the core worded itself (License server error.)
  - [+] isGatewayError > never claims a 502 the core worded itself (Could not start Qobuz sign-in: play.qobuz.com unreachable)
  - [+] isGatewayError > never claims a 502 the core worded itself (Favorite add failed)
  - [+] isGatewayError > never claims a 504 the core worded itself (HIGHRESAUDIO took too long to answer. It is not the box: the service is slow to reply.)
  - [+] isGatewayError > never claims a 503 the core worded itself (Qobuz not connected. Please authenticate via Sources.)
  ...
  - [+] signInFailureMessage — checked against what the servers really send > a licence server that answered badly → shows what it said, and does NOT re-probe the box
  - [+] signInFailureMessage — checked against what the servers really send > a HIGHRESAUDIO catalogue answering slowly → shows what it said, and does NOT re-probe the box
  - [+] signInFailureMessage — checked against what the servers really send > a Qobuz sign-in that could not start → shows what it said, and does NOT re-probe the box
...
**js/no-undef.test.js**
  ...
  - [+] no undeclared identifier anywhere in the tree > does not lint generated output that git already refuses to track (0.01s)
...
**js/offline-banner.test.js**
  ...
  - [+] the banner reserves its height wherever content starts under the topbar > declares that height once, as a dimension
  - [+] the banner reserves its height wherever content starts under the topbar > never writes that number out again (0.01s)
  - [+] the banner reserves its height wherever content starts under the topbar > sets the offset outside every desktop-only query
  - [+] the banner reserves its height wherever content starts under the topbar > is reserved by every surface that starts under the topbar
  - [+] the banner reserves its height wherever content starts under the topbar > steps the mobile horizontal tab bar down below the banner
  - [+] the banner reserves its height wherever content starts under the topbar > collapses to zero when the banner is parked off-screen
...
**js/push-manager.test.js**
  ...
  - [+] push-manager unsubscribe (Fix P3) > calls apiDelete (not apiPost) on unsubscribe (0.03s)
...
**js/pwa-manager.test.js**

  - [+] snapshots are coalesced instead of written on every event > writes once for a burst on the same key
  - [+] snapshots are coalesced instead of written on every event > keeps the last value, not the first
  - [+] snapshots are coalesced instead of written on every event > writes every distinct key in the same pass
  - [+] snapshots are coalesced instead of written on every event > dates a snapshot when it was taken, not when it was written
  - [+] snapshots are coalesced instead of written on every event > starts a new window after a flush
  - [+] nothing queued is lost when the app is put away > writes immediately rather than waiting out the window
  - [+] nothing queued is lost when the app is put away > does not write the same value twice when the timer then fires
  - [+] nothing queued is lost when the app is put away > survives a storage quota error without dropping the rest
  - [+] a reading is served from the queue while it waits there > hands back the queued value, not the older stored one
  - [+] a reading is served from the queue while it waits there > falls back to storage once the queue is empty
...
**js/status-dot.test.js**

  - [+] no status dot glows > .service-state-dot.up is green and flat
  - [+] no status dot glows > .profile-status-dot.up is green and flat
  - [+] no status dot glows > .profile-status.active is green and flat
  - [+] no status dot glows > .connection-dot-large.connected is green and flat
  - [+] no status dot glows > .lib-queue-lbl::before is green and flat
  - [+] no status dot glows > .lib-src-status.up .lib-src-dot is green and flat
  - [+] no status dot glows > has no glow when orange either
  - [+] no status dot glows > blinks by opacity alone
  - [+] no status dot glows > is flat in the pipeline node panel too

**js/sw.test.js**

  - [+] immutable assets are served from the cache, whatever their hash spells > serves /assets/main-Di28GOqk.js from the cache without touching the network
  - [+] immutable assets are served from the cache, whatever their hash spells > serves /assets/nowplaying-1_u92sT-.js from the cache without touching the network
  - [+] immutable assets are served from the cache, whatever their hash spells > serves /assets/webauthn-_7fd-y_O.js from the cache without touching the network
  - [+] immutable assets are served from the cache, whatever their hash spells > serves /assets/inter-latin-Dx4kXJAl.woff2 from the cache without touching the network
  - [+] immutable assets are served from the cache, whatever their hash spells > serves /assets/webauthn-Cg0gqqmA.css from the cache without touching the network
  - [+] immutable assets are served from the cache, whatever their hash spells > does not rewrite the precached entry for /assets/main-Di28GOqk.js on every load
  - [+] immutable assets are served from the cache, whatever their hash spells > does not rewrite the precached entry for /assets/nowplaying-1_u92sT-.js on every load
  - [+] immutable assets are served from the cache, whatever their hash spells > does not rewrite the precached entry for /assets/webauthn-_7fd-y_O.js on every load
  - [+] immutable assets are served from the cache, whatever their hash spells > does not rewrite the precached entry for /assets/inter-latin-Dx4kXJAl.woff2 on every load
  - [+] immutable assets are served from the cache, whatever their hash spells > does not rewrite the precached entry for /assets/webauthn-Cg0gqqmA.css on every load
  - [+] immutable assets are served from the cache, whatever their hash spells > does not claim a third party's /assets/ as its own
  ...
  - [+] a notification raises the window that is already open > steers the open interface to another page rather than stacking one
  - [+] a notification raises the window that is already open > still focuses when navigate() refuses, instead of doing nothing
  - [+] a notification raises the window that is already open > ignores a window belonging to another site
  - [+] a notification raises the window that is already open > opens nothing when the notification was dismissed
  - [+] the offline page reads the same in both copies of it > serves an English offline page
  - [+] the offline page reads the same in both copies of it > writes the brand as markup on both, as the rule says
  - [+] the offline page reads the same in both copies of it > keeps the last-resort string in English too
  ...
  - [+] dynamic data is never served from the cache > answers /sysinfo/current with the offline marker rather than a stale body
  - [+] dynamic data is never served from the cache > answers /auth/login with the offline marker rather than a stale body
...
**js/theme-boot.test.js**
  ...
  - [+] theme boot — reachable from the interface, and safe there > paints the chrome of a theme it knows (0.02s)
...
**js/topbar-buttons.test.js**

  - [+] the top bar draws all its buttons alike > still renders the Library button with the generic class
  - [+] the top bar draws all its buttons alike > gives it the settings button's own rule, not a copy of it
  - [+] the top bar draws all its buttons alike > does the same on hover, so it does not fill with a grey box
  - [+] the top bar draws all its buttons alike > leaves the footer's button alone
...
**js/version.test.js**
  ...
  - [+] version propagation (single source: audiogravity.ops/VERSION) > VERSION is a valid semver (0.9.60)
...
**js/components/library-constants.test.js**
  ...
  - [+] originBadgeName — the specific name the core already publishes > hands back the name the payload carries
  - [+] originBadgeName — the specific name the core already publishes > leaves the generic label alone when there is no specific name
  - [+] originBadgeName — the specific name the core already publishes > names HQPlayer when nothing else can be named
  - [+] originBadgeName — the specific name the core already publishes > does not hide the content behind the processor that plays it
  - [+] originBadgeName — the specific name the core already publishes > leaves a third-party renderer as external — AG cannot name it
  ...
  - [+] the radio is a source, and the picker knows it > resolves a playing station to the radio, not to the engine
  - [+] the radio is a source, and the picker knows it > keeps the radio out of the shared search picker, deliberately
  - [+] the radio is a source, and the picker knows it > keeps inputs out of it too — there is no catalogue behind a door
  ...
  - [+] resolvePlayingSource — SOURCE vs engine > still resolves by origin against a core that predates the field
  ...
  - [+] canAddToPlaylist — where "Add to playlist" may be offered > offers it on a HIGHRESAUDIO catalogue item
  - [+] canAddToPlaylist — where "Add to playlist" may be offered > never on a purchase: HIGHRESAUDIO files those in a tree of their own
  - [+] canAddToPlaylist — where "Add to playlist" may be offered > not on a source whose playlists the core cannot write yet
  - [+] canAddToPlaylist — where "Add to playlist" may be offered > not without an id
  - [+] canAddToPlaylist — where "Add to playlist" may be offered > lists the sources in one place, HIGHRESAUDIO alone today
  - [+] canOpenPlaylist / canEditPlaylist / canCreatePlaylist — a playlist's page > opens the account's playlists and the service's alike
  - [+] canOpenPlaylist / canEditPlaylist / canCreatePlaylist — a playlist's page > edits only the account's own — the service's selections are read-only
  - [+] canOpenPlaylist / canEditPlaylist / canCreatePlaylist — a playlist's page > does neither on a source whose playlists the core cannot open yet
  - [+] canOpenPlaylist / canEditPlaylist / canCreatePlaylist — a playlist's page > does neither without an id
  - [+] canOpenPlaylist / canEditPlaylist / canCreatePlaylist — a playlist's page > creates on the sources it writes
...
**js/core/FetchController.test.js**

  - [+] a panel that declares a snapshot key > saves what it fetched, under that key
  - [+] a panel that declares a snapshot key > serves the saved state instead of an error when the fetch fails
  - [+] a panel that declares a snapshot key > hands the saved state to onSuccess, in the shape the panel reads
  - [+] a panel that declares a snapshot key > still reports the failure when nothing was ever saved
  - [+] a panel that declares a snapshot key > drops the stale mark as soon as a fetch succeeds again
  - [+] a panel that declares a snapshot key > still calls onError, so a panel can react to the outage itself
  - [+] a panel that declares a snapshot key > tells onError that a snapshot was served, since `message` is then null
  - [+] a failure that carries a status is reported, never papered over > reports HTTP 401 rather than serving the snapshot
  - [+] a failure that carries a status is reported, never papered over > reports HTTP 403 rather than serving the snapshot
  - [+] a failure that carries a status is reported, never papered over > reports HTTP 500 rather than serving the snapshot
  - [+] a failure that carries a status is reported, never papered over > serves the snapshot for the service worker's own offline answer
  - [+] what may be saved is guarded separately from what may be served > refuses to save a payload the panel marks as degraded
  - [+] what may be saved is guarded separately from what may be served > saves it once the panel says the reading is whole
  - [+] what may be saved is guarded separately from what may be served > is declared by the one panel whose fetch degrades instead of failing
  - [+] what may be saved is guarded separately from what may be served > refuses to save an empty listing that a null body made look valid
  - [+] what may be saved is guarded separately from what may be served > still displays the degraded reading — the guard is on saving only
  - [+] a panel that declares nothing behaves exactly as before > saves nothing
  - [+] a panel that declares nothing behaves exactly as before > reports the failure, snapshot or not
  - [+] who may serve a stale reading, and who may never > ag-profiles-page.js keeps its reading for the next offline start
  - [+] who may serve a stale reading, and who may never > ag-services-page.js keeps its reading for the next offline start
  - [+] who may serve a stale reading, and who may never > ag-system-dashboard.js keeps its reading for the next offline start
  - [+] who may serve a stale reading, and who may never > ag-audio-software-page.js keeps its reading for the next offline start
  - [+] who may serve a stale reading, and who may never > ag-admin-page.js keeps its reading for the next offline start
  - [+] who may serve a stale reading, and who may never > ag-performance-page.js keeps its reading for the next offline start
  - [+] who may serve a stale reading, and who may never > ag-config-page.js must NEVER serve a stale reading — you can save from it
  - [+] who may serve a stale reading, and who may never > ag-systemd-page.js must NEVER serve a stale reading — you can save from it
  - [+] who may serve a stale reading, and who may never > ag-services-page.js guards what it saves, because its fetch resolves on a failure
  - [+] who may serve a stale reading, and who may never > ag-audio-software-page.js guards what it saves, because its fetch resolves on a failure
  - [+] who may serve a stale reading, and who may never > ag-admin-page.js guards what it saves, because its fetch resolves on a failure
  - [+] who may serve a stale reading, and who may never > ag-performance-page.js guards what it saves, because its fetch resolves on a failure
  - [+] who may serve a stale reading, and who may never > the log viewer never does either
  - [+] with no store registered at all > leaves a declared key inert rather than throwing

**js/core/ScrollEdgesController.test.js**

  - [+] ScrollEdgesController > registers itself with the host (0.01s)
...
**js/core/SwipeToDismissController.test.js**
  ...
  - [+] SwipeToDismissController > resting state — nothing red under an untouched row > reveals the backdrop while dragging and hides it once the row is back (0.05s)
  ...
  - [+] SwipeToDismissController > resting state — nothing red under an untouched row > cleans up per row: a gesture on another row does not strand the first (0.01s)
...
**js/core/keep-in-view.test.js**
  ...
  - [+] keepInView > centres the item in its own strip (0.24s)
...
**js/core/metrics-window.test.js**
  ...
  - [+] isMeasured > accepts any finite number, zero included
  - [+] isMeasured > rejects what the core sends when it has no reading
  - [+] appendBounded > returns a new array, leaving the one a chart holds untouched
  - [+] appendBounded > keeps only the newest entries
  - [+] appendBounded > starts a series that does not exist yet
...
**js/core/support-report-format.test.js**
  ...
  - [+] formatSupportReport — kernel, boots, ro, restarts, backups, network finds > names this box's own HQPlayer while it plays, with the card's choice alongside
  - [+] formatSupportReport — kernel, boots, ro, restarts, backups, network finds > says when the box's own runs with nothing chosen in the card
  - [+] formatSupportReport — kernel, boots, ro, restarts, backups, network finds > names the card's instance and whether the music goes to it
  - [+] formatSupportReport — kernel, boots, ro, restarts, backups, network finds > says the state could not be read rather than "not configured"
  ...
  - [+] formatSupportReport — the facts a certificate incident turns on > gives the address to type, the LAN one first
  - [+] formatSupportReport — the facts a certificate incident turns on > drops the port when it is the scheme default
  - [+] formatSupportReport — the facts a certificate incident turns on > drops a port that arrives as text just the same
  - [+] formatSupportReport — the facts a certificate incident turns on > gives no address where the interface did not answer
  - [+] formatSupportReport — the facts a certificate incident turns on > does not offer a name whose daemon is known to be down
  - [+] formatSupportReport — the facts a certificate incident turns on > keeps the name avahi itself returned when systemd could not be asked
  - [+] formatSupportReport — the facts a certificate incident turns on > still gives an address on a box that announces nothing
  - [+] formatSupportReport — the facts a certificate incident turns on > falls back to the name when the LAN address could not be read
  - [+] formatSupportReport — the facts a certificate incident turns on > prints no address line when it has neither half
...
**js/components/atoms/ag-library-cover.test.js**
  ...
  - [+] ag-library-cover — deferred image loading > marks the cover image as lazy so off-screen rows cost nothing (0.09s)
...
**js/components/atoms/ag-library-playlist-btn.test.js**

  - [+] ag-library-playlist-btn > reports the tap as playlist-add, to a listener above it (0.05s)
  - [+] ag-library-playlist-btn > never lets the tap reach the card that plays the album (0.01s)
  - [+] ag-library-playlist-btn > draws the row variant with its own class
  - [+] ag-library-playlist-btn > draws the card variant with its own class
  - [+] ag-library-playlist-btn > draws the player variant with its own class
  - [+] ag-library-playlist-btn > falls back to the row look for an unknown variant
  - [+] ag-library-playlist-btn > is named for assistive technology, and the name can be changed
  - [+] ag-library-playlist-btn — its three modes > the add mode fires playlist-add and is named "Add to playlist"
  - [+] ag-library-playlist-btn — its three modes > the remove mode fires playlist-remove and is named "Remove from the playlist"
  - [+] ag-library-playlist-btn — its three modes > the open mode fires playlist-open and is named "Open the playlist"
  - [+] ag-library-playlist-btn — its three modes > takes the bottom-left corner of a cover to open a playlist, which has no ★ there
  - [+] ag-library-playlist-btn — its three modes > keeps the row look in every mode, beside the other row controls
  - [+] ag-library-playlist-btn — its three modes > falls back to "add" for an unknown mode
  - [+] ag-library-playlist-btn — its three modes > never lets an "open" reach the card that plays the playlist
...
**js/components/atoms/ag-sparkline.test.js**
  ...
  - [+] placeOnSlots — a window with a width of its own > puts the newest measurement in the last slot
  - [+] placeOnSlots — a window with a width of its own > skips what was not measured but keeps its slot
  - [+] placeOnSlots — a window with a width of its own > keeps only the newest values when there are more than slots
  - [+] placeOnSlots — a window with a width of its own > uses one slot per value without a window
  - [+] placeOnSlots — a window with a width of its own > survives no data at all
  ...
  - [+] 'area' variant > takes its colours as CSS, so a var() resolves without JS
  - [+] 'area' variant > draws a measurement alone between two gaps as a point
  - [+] 'area' variant > draws a lone point of the second series too
  - [+] 'area' variant > marks no current value when the newest slot is empty
...
**js/components/molecules/ag-license-status.test.js**
  ...
  - [+] the purchase sentence when the licence server gives no price > keeps a whole sentence — no dangling comma (0.14s)
...
**js/components/molecules/ag-metric-detail.test.js**
  ...
  - [+] the expanded chart > draws a measurement alone between two gaps (0.04s)
  ...
  - [+] the expanded chart > shows a dash, not an older value, when the newest one is missing (0.02s)
...
**js/components/molecules/ag-package-card.test.js**
  ...
  - [+] ag-package-card — which way the offered version goes > falls back to "update" for a core that does not send the field yet (0.03s)
...
**js/components/molecules/ag-package-install-dialog.test.js**
  ...
  - [+] ag-package-install-dialog > accepting the licence > allows Install once they are (0.03s)
  - [+] ag-package-install-dialog > accepting the licence > asks for nothing when the package ships no notice (0.03s)
  - [+] ag-package-install-dialog > accepting the licence > shows the licence text it was given (0.03s)
  ...
  - [+] ag-package-install-dialog > choosing a version > sends the version that is selected (0.03s)
  ...
  - [+] ag-package-install-dialog > when the terms cannot be read > still asks for acceptance before Install (0.03s)
  ...
  - [+] ag-package-install-dialog > lines this box cannot install > does not offer them as a choice (0.03s)
  ...
  - [+] ag-package-install-dialog > the web interface password > keeps Install out of reach while the password is unusable, and says why (0.03s)
  - [+] ag-package-install-dialog > the web interface password > asks for nothing when the box already has credentials
  - [+] ag-package-install-dialog > the web interface password > draws a new one each time it opens (0.02s)
  - [+] ag-package-install-dialog > the web interface password > is not asked for a package without a web interface
  - [+] ag-package-install-dialog > keeps its buttons in the footer, out of the part that scrolls (0.01s)
...
**js/components/molecules/ag-playlist-page.test.js**
  ...
  - [+] ag-playlist-page — what it shows > goes back when asked (0.06s)
  - [+] ag-playlist-page — playing > plays the playlist from the track tapped, and opens the player (0.07s)
  - [+] ag-playlist-page — playing > plays the whole of it from Play, and queues the whole of it from Queue (0.09s)
  - [+] ag-playlist-page — playing > does not open the player when the play was refused (0.06s)
  ...
  - [+] ag-playlist-page — the account's own playlist > says so when the track had already gone, and takes it off the page all the same (0.11s)
...
**js/components/molecules/ag-service-card.test.js**
  ...
  - [+] a figure nobody measured > is a dash on the tile (0.01s)
...
**js/components/molecules/ag-volume-popover.test.js**
  ...
  - [+] ag-volume-popover live-value release > shows the dragged value while the hold lasts (0.17s)
...
**js/components/molecules/ag-web-password-field.test.js**
  ...
  - [+] ag-web-password-field > shows the password in clear and says where to sign in, as whom (0.06s)
  - [+] ag-web-password-field > hands each keystroke to its host
  - [+] ag-web-password-field > says what is wrong with an unusable password (0.02s)
  - [+] ag-web-password-field > never gives two fields the same id (0.02s)
...
**js/components/organisms/ag-audio-software-page.dialog.test.js**
  ...
  - [+] the uninstall dialog of the audio software page > uninstalls what the dialog confirmed, deleting the settings when ticked (0.01s)
...
**js/components/organisms/ag-audio-software-page.install.test.js**
  ...
  - [+] installing from the dialog > sends the chosen version and the acceptance
  - [+] installing from the dialog > sends the web interface password in the body, never in the URL
  - [+] installing from the dialog > sends an empty body when there is no password to set
  - [+] installing from the dialog > sends no password with any other action
  - [+] installing from the dialog > sends no version when none was chosen
  - [+] installing from the dialog > does not claim acceptance for anything but an install from the dialog
  - [+] installing from the dialog > shows why an install was turned down
  - [+] installing from the dialog > falls back to a generic line when the core gave no reason
  - [+] installing from the dialog > warns, rather than fails, when the package is installed but a step is left
...
**js/components/organisms/ag-audio-software-page.results.test.js**
  ...
  - [+] setting the web interface password from the card > shows the restart badge when the restart after it failed
...
**js/components/organisms/ag-config-editor.test.js**
  ...
  - [+] AgConfigEditor.disconnectedCallback — CodeMirror cleanup > calls toTextArea() on the CodeMirror instance and nulls the reference (0.01s)
  ...
  - [+] AgConfigEditor — guided/structured/expert mode switching > willUpdate opens a service with no form in the raw editor
...
**js/components/organisms/ag-guided-config.test.js**
  ...
  - [+] HQPlayer Embedded — its output alone > has the output as its only guided field
  - [+] HQPlayer Embedded — its output alone > has its output changed like any player's
  - [+] HQPlayer Embedded — its output alone > is offered no Reset to default
  - [+] HQPlayer Embedded — its output alone > leaves Reset to default to the services Audiogravity generates
  - [+] HQPlayer Embedded — its output alone > keeps Reset to default when nothing says otherwise
...
**js/components/organisms/ag-library-browse-pills.test.js**
  ...
  - [+] only a Refresh control asks the core to walk the source again > sends no refresh when a pill change reloads the list
  - [+] only a Refresh control asks the core to walk the source again > sends refresh=true when the reader presses Refresh
  - [+] only a Refresh control asks the core to walk the source again > sends it on an artist drill-down too, which reads the same cache
  - [+] only a Refresh control asks the core to walk the source again > and leaves it out of an artist drill-down that is only a reload
  - [+] only a Refresh control asks the core to walk the source again > never sends it on a page that continues a list
  - [+] only a Refresh control asks the core to walk the source again > still asks for the right order when it refreshes
...
**js/components/organisms/ag-library-browse.test.js**
  ...
  - [+] ag-library-browse — "Add to playlist" on an album > is offered on a HIGHRESAUDIO album card
  - [+] ag-library-browse — "Add to playlist" on an album > is not offered on a playlist card — a playlist is not an album
  - [+] ag-library-browse — "Add to playlist" on an album > is not offered on a purchase, which HIGHRESAUDIO files elsewhere
  - [+] ag-library-browse — "Add to playlist" on an album > is not offered on a source whose playlists the core cannot write
  - [+] ag-library-browse — "Add to playlist" on an album > asks the picker for the album, with what it shows
  - [+] ag-library-browse — "Add to playlist" on an album > marks the list row of an album, and not of a playlist
  - [+] ag-library-browse — a playlist's page > offers "open" on a HIGHRESAUDIO playlist card, the account's and the service's
  - [+] ag-library-browse — a playlist's page > keeps the tap on the card itself for playing it
  - [+] ag-library-browse — a playlist's page > offers no "open" on an album, nor on a source AG cannot open playlists of
  - [+] ag-library-browse — a playlist's page > marks a playlist's list row as openable, and an album's not
  - [+] ag-library-browse — a playlist's page > opens the page with the grid's heading as its way back
  - [+] ag-library-browse — a playlist's page > opens an editorial selection with its banner artwork
  - [+] ag-library-browse — a playlist's page > goes back to the grid where the reader left it — its scroll and its strips
  - [+] ag-library-browse — a playlist's page > rereads the account's playlists on the way back when they changed meanwhile
  - [+] ag-library-browse — a playlist's page > rereads the account's playlists at once when their grid is on screen
  - [+] ag-library-browse — a playlist's page > ignores a change on another source, or while another grid is on screen
  - [+] ag-library-browse — a playlist's page > leads the account's own playlists with a "New playlist" tile that opens the dialog
  - [+] ag-library-browse — a playlist's page > keeps the "New playlist" dialog for the account's own playlists
  - [+] ag-library-browse — a playlist's page > shows the tile only over the account's own playlists, on a source that can make one
...
**js/components/organisms/ag-library-page.test.js**
  ...
  - [+] ag-library-page — one home for the view mapping > every path that opens the radio goes through that same home
  ...
  - [+] ag-library-page — one home for the view mapping > _navigate reloads without asking the core to walk the source again
  - [+] ag-library-page — one home for the view mapping > the ↻ button is the one caller that does ask for it
  - [+] ag-library-page — one home for the view mapping > the ↻ handler ignores an event handed to it as its argument
...
**js/components/organisms/ag-library-search.test.js**
  ...
  - [+] ag-library-search — where a HIGHRESAUDIO search goes > uses the ordinary search while no filter is set (0.01s)
  ...
  - [+] ag-library-search — where a HIGHRESAUDIO search goes > searches a two-letter term, filtered or not (0.02s)
  ...
  - [+] ag-library-search — "Add to playlist" on an album result > marks a HIGHRESAUDIO album row
  - [+] ag-library-search — "Add to playlist" on an album result > not a track row: for a track, the full-screen player offers it
  - [+] ag-library-search — "Add to playlist" on an album result > not on a source whose playlists the core cannot write
  - [+] ag-library-search — "Add to playlist" on an album result > asks the picker for the album, with what the row shows

**js/components/organisms/ag-library-sources.test.js**

  - [+] _playingFrom — the source, not the engine > lights the radio, not Local Library, while a station plays
  - [+] _playingFrom — the source, not the engine > lights qobuz rather than the engine it streams over
  - [+] _playingFrom — the source, not the engine > lights tidal rather than the engine it streams over
  - [+] _playingFrom — the source, not the engine > lights highresaudio rather than the engine it streams over
  - [+] _playingFrom — the source, not the engine > leaves a local file on Local Library — there the engine IS the source
  - [+] _playingFrom — the source, not the engine > lights an input on its own node
  - [+] _playingFrom — the source, not the engine > lights nothing when nothing is playing
  - [+] _playingFrom — the source, not the engine > lights nothing on an empty state
  - [+] a UPnP server is a source too, and must not be mistaken for the engine > lights the server the track came from
  - [+] a UPnP server is a source too, and must not be mistaken for the engine > never lights Local Library for a server this screen does not know
  - [+] a UPnP server is a source too, and must not be mistaken for the engine > names nothing when the backend could not identify the server
  - [+] a UPnP server is a source too, and must not be mistaken for the engine > uses the id, not the name, for two servers that share one
  - [+] several sources can diffuse at once > lights both, whichever one the player is following
  - [+] several sources can diffuse at once > lights both when the OTHER one started first
  - [+] several sources can diffuse at once > names each stream by its own content, not by the engine carrying it
  - [+] _withStatus — the status is derived, never stored > marks every playing card and no other
  - [+] _withStatus — the status is derived, never stored > keeps the node it was given
  - [+] _withStatus — the status is derived, never stored > reads the key back as a set, so a quiet tick re-renders nothing
  - [+] a core that does not send the type must not empty the screen > falls back to what the old filter meant, without its list of names
  - [+] a core that does not send the type must not empty the screen > keeps a routing handle out of both halves
  - [+] a core that does not send the type must not empty the screen > carries the two fields the fallback reads
  - [+] a core that does not send the type must not empty the screen > uses the type as soon as one entry carries it
...
**js/components/organisms/ag-logs-escaping.test.js**
  ...
  - [+] ag-log-viewer > keeps markup in a message as text (0.03s)
...
**js/components/organisms/ag-mobile-pipeline.test.js**
  ...
  - [+] a card names where the audio comes from, not just what carries it > reads the provider from the player state, which the pipeline does not carry
  - [+] a card names where the audio comes from, not just what carries it > prefers the server or station name over the generic word
  - [+] a card names where the audio comes from, not just what carries it > joins HQPlayer across the two ids the sides use for it
  - [+] a card names where the audio comes from, not just what carries it > stays quiet when the provider would only repeat the transport
  - [+] a card names where the audio comes from, not just what carries it > stays quiet when the two pills merely word the same thing differently
  - [+] a card names where the audio comes from, not just what carries it > stays quiet for an origin that names no provider at all
  - [+] a card names where the audio comes from, not just what carries it > says nothing rather than guessing when the player knows no origin
  - [+] reading the player stream costs the box nothing > joins the stream the mini player already holds open, without a request
...
**js/components/organisms/ag-now-playing-fullscreen.test.js**
  ...
  - [+] AgNowPlayingFullscreen — "Add to playlist" for the track playing now > is offered for a HIGHRESAUDIO track the box can name (0.03s)
  - [+] AgNowPlayingFullscreen — "Add to playlist" for the track playing now > is not offered for a purchase
  - [+] AgNowPlayingFullscreen — "Add to playlist" for the track playing now > is not offered for a track the box cannot name
  - [+] AgNowPlayingFullscreen — "Add to playlist" for the track playing now > is not offered for another service
...
**js/components/organisms/ag-now-playing.test.js**
  ...
  - [+] the source badge is given the specific name, not just the kind > passes a name to every ag-source-badge it renders
  - [+] the source badge is given the specific name, not just the kind > takes that name from the shared resolver rather than a table of its own
  - [+] the playback bar leaves the playback modes to the fullscreen player > sends no repeat or shuffle control from the bar
  - [+] the playback bar leaves the playback modes to the fullscreen player > carries neither icon, nor the rules that styled the buttons
...
**js/components/organisms/ag-services-page.test.js**
  ...
  - [+] the chart history holds only what was measured > starts empty, not with a window of zeros
  - [+] the chart history holds only what was measured > keeps a measurement the service did not report as a gap, not a zero
  - [+] the chart history holds only what was measured > keeps rates the machine does not count as gaps too
  - [+] the chart history holds only what was measured > keeps only the series a card draws
  - [+] the chart history holds only what was measured > opens a gap after a pause in the stream
  - [+] the chart history holds only what was measured > opens no gap at the core slowest rate
  - [+] the chart history holds only what was measured > holds no more than the chart window
  - [+] the chart history holds only what was measured > hands the chart a new array at every measurement
...
**js/components/organisms/ag-system-dashboard.test.js**
  ...
  - [+] only what an update measured enters a chart > draws no temperature on a machine without a sensor
  - [+] only what an update measured enters a chart > takes a reading of 0 as a reading
  - [+] a pause in the stream > opens a gap in every chart
  - [+] a pause in the stream > opens none at the core slowest rate
  - [+] a pause in the stream > gives no network rate across it, which would average the whole silence
