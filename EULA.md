...
**"License Key"** — the unique order code used to activate and download the License File.
...
**Starter Edition** — Non-exclusive, non-transferable, free and perpetual use within
the Starter Edition functional limits.

**Pro License** — Perpetual, non-exclusive, non-transferable use of the Software
and updates within the purchased major version, on one installation, one machine.
Pro License holders receive a preferential upgrade price for new major versions.

## 3. Trial License

A 30-day trial is automatically activated on first installation, providing full access.
Upon expiry, the Software reverts to Starter Edition. Any attempt to bypass this mechanism
constitutes a breach of this EULA.

## 4. Restrictions

You may not: reverse-engineer or decompile the Software; distribute, sell, or transfer it;
...
The Software is provided without warranty. The Licensor's total liability shall not exceed the
